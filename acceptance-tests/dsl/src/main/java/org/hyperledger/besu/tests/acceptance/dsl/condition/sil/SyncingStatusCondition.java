...
import org.hyperledger.besu.tests.acceptance.dsl.transaction.sil.SilSyncingTransaction;

public class SyncingStatusCondition implements Condition {

  private final SilSyncingTransaction transaction;
  private final boolean syncingMiningStatus;

  public SyncingStatusCondition(
      final SilSyncingTransaction transaction, final boolean syncingStatus) {
