...
public class CustomRequestFactory {
  ...
  public static class SilGetTransactionReceiptWithRevertReasonResponse
      extends Response<TransactionReceiptWithRevertReason> {}

  /**
   * Block result that includes the slotNumber field introduced by SIP-7843 (SilaAmsterdam+). This
   * provides access to the slot number field that is not available in standard web3j SilBlock.
   */
  ...
  public static class SilGetBlockWithSlotNumberResponse extends Response<BlockWithSlotNumber> {}
  ...
  public Request<?, SilGetTransactionReceiptWithRevertReasonResponse>
      silGetTransactionReceiptWithRevertReason(final String transactionHash) {
    return new Request<>(
        "sil_getTransactionReceipt",
        Collections.singletonList(transactionHash),
        web3jService,
        SilGetTransactionReceiptWithRevertReasonResponse.class);
  }

  /**
   * Fetches a block by number with slotNumber field (SIP-7843, SilaAmsterdam+).
   *
   ...
   */
  public Request<?, SilGetBlockWithSlotNumberResponse> silGetBlockByNumberWithSlotNumber(
    ...
    return new Request<>(
        ...
        web3jService,
        SilGetBlockWithSlotNumberResponse.class);
  }
}
