...
public class ThreadBesuNodeRunner implements BesuNodeRunner {
  ...
  public void startNode(final BesuNode node) {
    ...
    final SilNetworkConfig.Builder networkConfigBuilder = component.silNetworkConfigBuilder();
  ...
  public interface AcceptanceTestBesuComponent extends BesuComponent {
    ...
    SilNetworkConfig.Builder silNetworkConfigBuilder();
