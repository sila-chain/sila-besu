...
import org.hyperledger.besu.tests.acceptance.dsl.transaction.sil.SilFilterChangesTransaction;
...
public class NewPendingTransactionFilterChangesCondition implements Condition {
  ...
  private final SilFilterChangesTransaction filterChanges;
  private final List<String> transactionHashes;

  public NewPendingTransactionFilterChangesCondition(
      final SilFilterChangesTransaction filterChanges, final List<String> transactionHashes) {
