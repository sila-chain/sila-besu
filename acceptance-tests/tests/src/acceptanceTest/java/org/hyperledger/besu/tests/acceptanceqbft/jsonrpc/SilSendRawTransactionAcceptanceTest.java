...
public class SilSendRawTransactionAcceptanceTest extends AcceptanceTestBase {
  ...
  public void setUp() throws Exception {
    ...
    final var minerChainHead = miningNode.execute(silTransactions.block());
  ...
  private TransferTransaction createTransaction(final boolean withChainId) {
    if (withChainId) {
      ...
      final BigInteger nonce =
          miningNode.execute(silTransactions.getTransactionCount(sender.getAddress()));
