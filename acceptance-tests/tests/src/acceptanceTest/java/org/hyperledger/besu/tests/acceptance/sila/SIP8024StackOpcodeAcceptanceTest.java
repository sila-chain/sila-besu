 ...
 *
 * <p>SIP-8024 introduces three new SAVM opcodes for extended stack manipulation:
 *
 * <ul>
 ...
 */
public class SIP8024StackOpcodeAcceptanceTest extends AcceptanceTestBase {
  private static final String GENESIS_FILE = "/dev/dev_amsterdam.json";
  private static final SECP256K1 secp256k1 = new SECP256K1();

  // SIP-8024 test contract addresses (pre-deployed in genesis)
  ...
  void setUp() throws IOException {
    ...
    dupnContract = Account.create(silTransactions, DUPN_CONTRACT_ADDRESS);
    swapnContract = Account.create(silTransactions, SWAPN_CONTRACT_ADDRESS);
    exchangeContract = Account.create(silTransactions, EXCHANGE_CONTRACT_ADDRESS);
  }
  ...
  public void testDupNBasicOperation() throws IOException {
    ...
    final String storageValue =
        besuNode.execute(silTransactions.getStorageAt(dupnContract, BigInteger.ZERO));
  ...
  public void testSwapNBasicOperation() throws IOException {
    ...
    final String storageValue =
        besuNode.execute(silTransactions.getStorageAt(swapnContract, BigInteger.ZERO));
  ...
  public void testExchangeBasicOperation() throws IOException {
    ...
    final String storageValue =
        besuNode.execute(silTransactions.getStorageAt(exchangeContract, BigInteger.ZERO));
    assertThat(storageValue)
