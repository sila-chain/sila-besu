...
public class TransactionPoolValidatorPluginTest extends AcceptanceTestBase {
  ...
  public void transactionIsRejectedByPlugin2() {
    ...
    assertThatThrownBy(() -> node.execute(silTransactions.sendRawTransaction(rawSigned)))
