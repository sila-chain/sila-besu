...
public class RpcApisTogglesAcceptanceTest extends AcceptanceTestBase {
  ...
  private BesuNode silApiDisabledNode;
  ...
  public void before() throws Exception {
    ...
    silApiDisabledNode = besu.createArchiveNodeWithRpcApis("sil-api-disabled", RpcApis.NET.name());
    cluster.start(rpcEnabledNode, rpcDisabledNode, silApiDisabledNode);
  }
  ...
  public void shouldSucceedCallingMethodFromEnabledApiGroup() {
    silApiDisabledNode.verify(net.netVersion());
  }
  ...
  public void shouldFailCallingMethodFromDisabledApiGroup() {
    ...
    silApiDisabledNode.verify(sil.accountsExceptional(expectedMessage));
  }
}
