...
public class PermissioningPluginTest extends AcceptanceTestBase {
  ...
  public void allowFilteredByGasLimit() {
    ...
    final String txHash = aliceNode.execute(silTransactions.sendRawTransaction(rawSigned));
  ...
  public void blockedFilteredByGasLimit() {
    ...
    assertThatThrownBy(() -> aliceNode.execute(silTransactions.sendRawTransaction(rawSigned)))
