...
public class SilGetBlockByNumberAndHashSilaShanghaiAcceptanceTest extends AbstractJsonRpcTest {
  private static final String TEST_RESOURCES_DIR = "/jsonrpc/sil/getBlockBy/";
  ...
  public SilGetBlockByNumberAndHashSilaShanghaiAcceptanceTest() {
    super(testsContext);
  }
