...
public class ExecutionEngineSilaCancunBlockBuildingAcceptanceTest extends AbstractJsonRpcTest {
  ...
  public ExecutionEngineSilaCancunBlockBuildingAcceptanceTest() {
    super(testsContext);
  }
