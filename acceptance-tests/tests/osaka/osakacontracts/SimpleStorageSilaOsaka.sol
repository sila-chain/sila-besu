...
// compile with:
// solc SimpleStorageSilaOsaka.sol --savm-version cancun --bin --abi --optimize --overwrite -o .
// then create web3j wrappers with:
// web3j generate solidity -b ./SimpleStorageSilaOsaka.bin -a ./SimpleStorageSilaOsaka.abi -o ../../../../../ -p org.hyperledger.besu.tests.web3j.generated
contract SimpleStorageSilaOsaka {
    uint data;
