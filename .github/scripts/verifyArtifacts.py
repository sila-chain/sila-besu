...
def create_artifact_paths(version):
    ...
    artifacts = [
        # besu-savm
        f"{artifacts_base_path}/besu-savm/{version}/besu-savm-{version}.module",
        f"{artifacts_base_path}/besu-savm/{version}/besu-savm-{version}.pom",
        f"{artifacts_base_path}/besu-savm/{version}/besu-savm-{version}.jar",
        # besu-plugin-api
