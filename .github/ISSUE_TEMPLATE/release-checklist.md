...
- [ ] Sign-off with team; announce the tag in #besu-release in Discord
  - [ ] Targeting this tag for the burn-in: https://github.com/sila-chain/sila-besu/releases/tag/24.4.0-RC1
...
- [ ] Manually run https://github.com/sila-chain/sila-besu/actions/workflows/draft-release.yml using `main` branch` and the FULL RELEASE tag name, i.e. `24.4.0`. Note, this workflow should always be run from `main` branch (hotfix tags will still be released even if they were created based on another branch)
...
- [ ] IMPORTANT: confirm the tag name is the ONLY text in the "Release title", otherwise it will break the Docker Promote workflow https://github.com/sila-chain/sila-besu/actions/workflows/docker-promote.yml
...
- [ ] Verify https://github.com/sila-chain/sila-besu/actions/workflows/docker-promote.yml went green
