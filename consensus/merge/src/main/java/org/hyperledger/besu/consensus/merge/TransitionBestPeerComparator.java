...
import static org.hyperledger.besu.sila.sil.manager.SilPeers.CHAIN_HEIGHT;
...
public class TransitionBestPeerComparator
    implements Comparator<SilPeerImmutableAttributes>, MergeStateHandler {

  private static final AtomicReference<Difficulty> terminalTotalDifficulty =
      new AtomicReference<>();

  /** The Distance from ttd. */
  static final BiFunction<SilPeerImmutableAttributes, Difficulty, BigInteger> distanceFromTTD =
      (a, ttd) ->
  ...
  public static final Comparator<SilPeerImmutableAttributes> EXACT_DIFFICULTY =
      (a, b) -> {
  ...
  public static final Comparator<SilPeerImmutableAttributes> BEST_MERGE_CHAIN =
  ...
  @Override
  public int compare(final SilPeerImmutableAttributes o1, final SilPeerImmutableAttributes o2) {
