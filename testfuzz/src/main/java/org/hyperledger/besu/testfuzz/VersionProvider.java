...
/**
 * The VersionProvider class is responsible for providing the version of the Hyperledger Besu SAVM
...
public class VersionProvider implements CommandLine.IVersionProvider {
  ...
  /**
   * This method returns the version of the Hyperledger Besu SAVM tool.
   *
   * @return A string array containing the version of the Hyperledger Besu SAVM tool.
   */
  @Override
  public String[] getVersion() {
    return new String[] {"Hyperledger Besu savm " + BesuVersionUtils.shortVersion()};
  }
}
