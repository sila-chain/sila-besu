...
The P256Verify fuzzer tests the SIP-7951 P256 signature verification precompiled contract with a comprehensive test matrix:
...
- `--guidance-regexp`: Regex for coverage guidance (default: focuses on SAVM and crypto classes)
