...
public class Eip8037StateGasCostCalculator implements StateGasCostCalculator {
  ...
  /**
   * Execution gas for SIP-7702 auth base (calldata + ecrecover + cold access + warm write ≈ 7500).
  ...
  /**
   * The mainnet transaction gas limit cap from SIP-7825 (2^24), enforced at runtime on execution
