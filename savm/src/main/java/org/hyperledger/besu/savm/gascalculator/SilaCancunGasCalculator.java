...
/**
 * Gas Calculator for SilaCancun
 *
 * <UL>
 *   <LI>Gas costs for TSTORE/TLOAD
 *   <LI>Blob gas for SIP-4844
 * </UL>
 */
public class SilaCancunGasCalculator extends SilaShanghaiGasCalculator {

  /** Instantiates a new SilaCancun Gas Calculator. */
  public SilaCancunGasCalculator() {
   ...
   */
  protected SilaCancunGasCalculator(final int maxPrecompile) {
    super(maxPrecompile);
  }
