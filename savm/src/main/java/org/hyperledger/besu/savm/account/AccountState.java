 ...
 */
package org.hyperledger.besu.savm.account;
 ...
 *       "removing" that key).
 *   <li><b>Code:</b> arbitrary-length sequence of bytes that corresponds to SAVM bytecode.
 *   <li><b>Version:</b> the version of the SAVM bytecode.
 * </ul>
 */
public interface AccountState {
  ...
  /**
   * The SAVM bytecode associated with this account.
   *
  ...
  /**
   * The SAVM bytecode associated with this account, wrapped in a {@link Code} object.
   *
  ...
  /**
   * The hash of the SAVM bytecode associated with this account.
   *
  ...
  /**
   * Whether the account has (non empty) SAVM bytecode associated to it.
   *
   * <p>This is functionally equivalent to {@code !code().isEmpty()}, though could be implemented
   * more efficiently.
   *
   * @return Whether the account has SAVM bytecode associated to it.
   */
