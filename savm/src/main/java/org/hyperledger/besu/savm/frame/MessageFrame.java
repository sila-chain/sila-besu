...
public class MessageFrame {
  ...
  // SAVM v2 stack: 4 longs per 256-bit word (index 0 = most significant, index 3 = least
  // significant)
  ...
  private MessageFrame(
    ...
    this.sip7928AccessList = sip7928AccessList;
  ...
  // region --- SAVM v2 long[] stack operations ---
  // ---------------------------------------------------------------------------
  ...
  public void incrementStateGasReservoir(final long amount) {
    ...
    if (LOG.isTraceEnabled()) {
      LOG.trace(
          "SIP-8037 CREDIT_RESERVOIR depth={} amount={} reservoirBefore={} reservoirAfter={}",
          getDepth(),
          amount,
          before,
          after);
  ...
  // ============================================================
  // End SIP-8037 state gas accounting
  // ============================================================
  ...
  /**
   * "Warms up" the address as per SIP-2929
   *
  ...
  /**
   * "Warms up" the storage slot as per SIP-2929
   *
  ...
  public static class Builder {
    ...
    /**
     * Sets SIP 2930 Access list warm addresses.
     *
     * @param accessListWarmAddresses the access list warm addresses
     * @return the builder
     */
    public Builder sip2930AccessListWarmAddresses(final Set<Address> accessListWarmAddresses) {
      this.sip2930AccessListWarmAddresses = accessListWarmAddresses;
      return this;
    }

    /**
     * Sets SIP 2930 Access list warm storage.
     *
     * @param accessListWarmStorage the access list warm storage
     * @return the builder
     */
    public Builder sip2930AccessListWarmStorage(
        final Multimap<Address, Bytes32> accessListWarmStorage) {
      this.sip2930AccessListWarmStorage = accessListWarmStorage;
      return this;
    }

    /**
     * Sets SIP 7928 access list to record account and storage accesses.
     *
    ...
    /**
     * SIP-8037: initial state-gas reservoir for the transaction's top-level frame. Ignored for
    ...
    public MessageFrame build() {
      ...
      for (Address a : sip2930AccessListWarmAddresses) {
        messageFrame.warmUpAddress(a);
      }
      for (var e : sip2930AccessListWarmStorage.entries()) {
