...
import org.hyperledger.besu.savm.gascalculator.StorageTransition;
...
public class SStoreOperation extends AbstractOperation {
  ...
  /** The constant SIP_1706_MINIMUM. */
  public static final long SIP_1706_MINIMUM = 2300L;
  ...
  public OperationResult execute(final MessageFrame frame, final SAVM savm) {
    ...
    // SIP-8037: Refund state gas for 0→X→0 (storage set then clear), otherwise charge state gas
