...
/**
 * Strategy interface for emitting SIL transfer logs.
 *
 * <p>This allows different implementations for different protocol versions:
 *
 * <ul>
 *   <li>{@link #NOOP} - No-op implementation for pre-SilaAmsterdam forks
 *   <li>{@link SIP7708TransferLogEmitter} - SIP-7708 compliant implementation for SilaAmsterdam+
 * </ul>
 */
public interface TransferLogEmitter {

  /**
   * Emit a transfer log for an SIL value transfer.
   *
  ...
  default void emitSelfDestructLog(
      ...
      final Wei value) {
    // No-op by default (pre-SilaAmsterdam)
  }
  ...
  /** No-op implementation. Used for pre-SilaAmsterdam forks. */
