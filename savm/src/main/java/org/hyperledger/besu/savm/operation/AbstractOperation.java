...
public abstract class AbstractOperation implements Operation {
   ...
   *
   * <p>If an SIP-7928 Block Access List is active, the address is added to the access list.
   *
   ...
   *
   * <p>If an SIP-7928 Block Access List is active, the sender address is added to the access list.
   *
   * @param frame the current message execution frame
   ...
   *
   * <p>If an SIP-7928 Block Access List is active, the slot access is recorded for the account.
   *
