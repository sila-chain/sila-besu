...
/**
 * Gas Calculator for SilaOsaka
 *
 * <UL>
 *   <LI>TBD
 * </UL>
 */
public class SilaOsakaGasCalculator extends SilaPragueGasCalculator {
  ...
  /** Instantiates a new SilaOsaka Gas Calculator. */
  public SilaOsakaGasCalculator() {
   ...
   */
  protected SilaOsakaGasCalculator(final int maxPrecompile, final int maxL2Precompile) {
    super(maxPrecompile);
    this.maxL2Precompile = maxL2Precompile;
  }

  /**
   * Instantiates a new SilaOsaka Gas Calculator, uses default P256_VERIFY as max L2 precompile.
   *
   * @param maxPrecompile the max precompile address from the L1 precompile range (0x01 - 0xFF)
   */
  protected SilaOsakaGasCalculator(final int maxPrecompile) {
