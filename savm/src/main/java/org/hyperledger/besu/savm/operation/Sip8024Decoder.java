...
/**
 * Shared decoder tables for SIP-8024 operations (DUPN, SWAPN, EXCHANGE).
 *
 * <p>SIP-8024 uses special immediate encoding to avoid bytes that could be confused with JUMPDEST
...
public final class Sip8024Decoder {

  private Sip8024Decoder() {
    // Utility class
  }
  ...
  /**
   * Initialize decode tables for single operand per SIP-8024 decode_single specification:
   *
   * <pre>
  ...
  /**
   * Initialize decode tables for pair operand per SIP-8024 decode_pair specification:
   *
   * <pre>
