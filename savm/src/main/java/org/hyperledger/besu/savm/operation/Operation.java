...
public interface Operation {
   ...
   * @param savm The SAVM for execution of this operation.
   * @return the gas cost and any exceptional halt reasons of the operation.
   */
  OperationResult execute(final MessageFrame frame, final SAVM savm);
   ...
   * if the contract is not ended by a STOP opcode the {@link SAVM} adds an explicit end of script
