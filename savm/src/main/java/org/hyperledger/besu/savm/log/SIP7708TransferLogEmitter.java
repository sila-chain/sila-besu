...
/**
 * SIP-7708 compliant transfer log emitter.
 *
 * <p>Emits a LOG3-equivalent log for all nonzero SIL value transfers with:
 *
 * <ul>
 ...
 * </ul>
 */
public class SIP7708TransferLogEmitter implements TransferLogEmitter {

  /** Singleton instance for use in SilaAmsterdam+ protocol specs. */
  public static final TransferLogEmitter INSTANCE = new SIP7708TransferLogEmitter();

  /** The system address used as the log emitter for SIP-7708 transfer logs. */
  public static final Address SIP7708_SYSTEM_ADDRESS =
      Address.fromHexString("0xfffffffffffffffffffffffffffffffffffffffe");

  /**
   * The Transfer event signature topic: keccak256('Transfer(address,address,uint256)').
   *
   * <p>This is the same topic used by SRC-20 Transfer events.
   */
  ...
  private SIP7708TransferLogEmitter() {}

  /**
   * Creates an SIP-7708 compliant transfer log.
   *
  ...
  /**
   * Creates an SIP-7708 compliant burn log (LOG2).
   *
  ...
  public static Log createBurnLog(final Address closedAddress, final Wei value) {
    ...
    return new Log(
        SIP7708_SYSTEM_ADDRESS, data, ImmutableList.of(LogTopic.create(BURN_TOPIC), addressTopic));
  }
