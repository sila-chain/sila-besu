...
/** The Big integer modular exponentiation precompiled contract defined in SIP-198. */
public class BigIntegerModularExponentiationPrecompiledContract
  ...
  public PrecompileContractResult computePrecompile(
    ...
    // https://sips.sila.org/SIPS/sip-7823
  ...
  public static long extractParameterLong(final Bytes input, final int offset, final int length) {
    ...
    if (offset + length <= input.size()) {
      ...
      // Sila's memory is always infinitely full of zeros, but we don't store those zeros, just
