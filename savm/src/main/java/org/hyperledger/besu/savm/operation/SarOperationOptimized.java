...
import static org.hyperledger.besu.savm.operation.Shift256Operations.ALL_ONES;
import static org.hyperledger.besu.savm.operation.Shift256Operations.ALL_ONES_BYTES;
import static org.hyperledger.besu.savm.operation.Shift256Operations.getLong;
import static org.hyperledger.besu.savm.operation.Shift256Operations.isShiftOverflow;
import static org.hyperledger.besu.savm.operation.Shift256Operations.putLong;
import static org.hyperledger.besu.savm.operation.Shift256Operations.shiftRight;
...
public class SarOperationOptimized extends AbstractFixedCostOperation {
  ...
  /**
   * Performs a 256-bit arithmetic right shift (SAVM SAR).
   *
