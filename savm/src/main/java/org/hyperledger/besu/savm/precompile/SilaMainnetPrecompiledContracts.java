...
public interface SilaMainnetPrecompiledContracts {
  ...
  /**
   * SilaCancun precompile contract registry.
   *
   * @param gasCalculator the gas calculator
   * @return the precompile contract registry
   */
  ...
  /**
   * Populate registry for SilaCancun.
   *
   * @param registry the registry
   * @param gasCalculator the gas calculator
   */
  ...
  /**
   * SilaPrague precompile contract registry.
   *
   * @param gasCalculator the gas calculator
   * @return the precompile contract registry
   */
  ...
  /**
   * Populate registry for SilaPrague.
   *
   * @param registry the registry
   * @param gasCalculator the gas calculator
   */
  ...
  /**
   * SilaOsaka precompile contract registry.
   *
   * @param gasCalculator the gas calculator
   * @return the precompile contract registry
   */
  ...
  /**
   * Populate registry for SilaOsaka.
   *
   * @param registry the registry
   * @param gasCalculator the gas calculator
   */
  ...
  /**
   * Populate registry for Future SIPs.
   *
   * @param registry the registry
   * @param gasCalculator the gas calculator
   */
