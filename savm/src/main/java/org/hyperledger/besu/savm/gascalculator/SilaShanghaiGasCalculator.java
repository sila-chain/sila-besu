...
import static org.hyperledger.besu.savm.internal.Words.numWords;

/** The SilaShanghai gas calculator. */
public class SilaShanghaiGasCalculator extends LondonGasCalculator {

  private static final long INIT_CODE_COST = 2L;

  /**
   * Instantiates a new SilaShanghaiGasCalculator
   *
   * @param maxPrecompile the max precompile
   */
  protected SilaShanghaiGasCalculator(final int maxPrecompile) {
    super(maxPrecompile);
  }

  /** Instantiates a new SilaShanghaiGasCalculator */
  public SilaShanghaiGasCalculator() {
    super();
  }
