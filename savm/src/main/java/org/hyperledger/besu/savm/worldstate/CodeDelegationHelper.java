...
import static org.hyperledger.besu.savm.Code.EMPTY_CODE;
...
public class CodeDelegationHelper {
   ...
   * @param sip7928AccessList data structure to record account and storage accesses.
  ...
  public static Target getTarget(
    ...
    return new Target(
        targetAddress,
        processTargetCode(worldUpdater, isPrecompile, targetAddress, sip7928AccessList));
  }
  ...
  private static Code processTargetCode(
    ...
    sip7928AccessList.ifPresent(t -> t.addTouchedAccount(targetAddress));
