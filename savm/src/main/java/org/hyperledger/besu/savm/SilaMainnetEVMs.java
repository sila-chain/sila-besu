...
public class SilaMainnetEVMs {
  ...
  private static OperationRegistry parisOperations(
      ...
      final SavmConfiguration savmConfiguration) {
    OperationRegistry operationRegistry = new OperationRegistry();
    registerParisOperations(operationRegistry, gasCalculator, chainId, savmConfiguration);
    return operationRegistry;
  }
  ...
  private static OperationRegistry shanghaiOperations(
      ...
      final SavmConfiguration savmConfiguration) {
    OperationRegistry operationRegistry = new OperationRegistry();
    registerShanghaiOperations(operationRegistry, gasCalculator, chainId, savmConfiguration);
    return operationRegistry;
  }
  ...
  private static void registerShanghaiOperations(
      ...
      final BigInteger chainID,
      final SavmConfiguration savmConfiguration) {
    registerParisOperations(registry, gasCalculator, chainID, savmConfiguration);
  ...
  private static OperationRegistry cancunOperations(
      ...
      final SavmConfiguration savmConfiguration) {
    OperationRegistry operationRegistry = new OperationRegistry();
    registerCancunOperations(operationRegistry, gasCalculator, chainId, savmConfiguration);
    return operationRegistry;
  }
  ...
  private static void registerCancunOperations(
      ...
      final BigInteger chainID,
      final SavmConfiguration savmConfiguration) {
    registerShanghaiOperations(registry, gasCalculator, chainID, savmConfiguration);
  ...
  private static OperationRegistry pragueOperations(
      ...
      final SavmConfiguration savmConfiguration) {
    OperationRegistry operationRegistry = new OperationRegistry();
    registerPragueOperations(operationRegistry, gasCalculator, chainId, savmConfiguration);
    return operationRegistry;
  }
  ...
  private static void registerPragueOperations(
      ...
      final BigInteger chainID,
      final SavmConfiguration savmConfiguration) {
    registerCancunOperations(registry, gasCalculator, chainID, savmConfiguration);
  }
  ...
  private static OperationRegistry osakaOperations(
      ...
      final SavmConfiguration savmConfiguration) {
    OperationRegistry operationRegistry = new OperationRegistry();
    registerOsakaOperations(operationRegistry, gasCalculator, chainId, savmConfiguration);
    return operationRegistry;
  }
  ...
  private static void registerOsakaOperations(
      ...
      final BigInteger chainID,
      final SavmConfiguration savmConfiguration) {
    registerPragueOperations(registry, gasCalculator, chainID, savmConfiguration);
  ...
  private static OperationRegistry amsterdamOperations(
      ...
      final SavmConfiguration savmConfiguration) {
    OperationRegistry operationRegistry = new OperationRegistry();
    registerAmsterdamOperations(operationRegistry, gasCalculator, chainId, savmConfiguration);
    return operationRegistry;
  }
  ...
  private static void registerAmsterdamOperations(
      ...
      final BigInteger chainID,
      final SavmConfiguration savmConfiguration) {
    registerOsakaOperations(registry, gasCalculator, chainID, savmConfiguration);
  ...
  private static void registerBogotaOperations(
      ...
      final BigInteger chainID,
      final SavmConfiguration savmConfiguration) {
    registerAmsterdamOperations(registry, gasCalculator, chainID, savmConfiguration);
  }
   ...
   * @return the savm
   */
  public static SAVM futureEips(final SavmConfiguration savmConfiguration) {
    return futureEips(DEV_NET_CHAIN_ID, savmConfiguration);
  }
   ...
   * @return the savm
   */
  public static SAVM futureEips(
      final BigInteger chainId, final SavmConfiguration savmConfiguration) {
    return futureEips(new SilaPragueGasCalculator(), chainId, savmConfiguration);
  }
  ...
  public static SAVM futureEips(
      ...
      final SavmConfiguration savmConfiguration) {
    return new SAVM(
        futureEipsOperations(gasCalculator, chainId, savmConfiguration),
        gasCalculator,
        savmConfiguration,
        SavmSpecVersion.FUTURE_EIPS);
  }
  ...
  private static OperationRegistry futureEipsOperations(
      ...
      final SavmConfiguration savmConfiguration) {
    OperationRegistry operationRegistry = new OperationRegistry();
    registerFutureEipsOperations(operationRegistry, gasCalculator, chainId, savmConfiguration);
    return operationRegistry;
  }
   ...
   * @return the savm
   */
  public static SAVM experimentalEips(final SavmConfiguration savmConfiguration) {
    return experimentalEips(DEV_NET_CHAIN_ID, savmConfiguration);
  }
   ...
   * @return the savm
   */
  public static SAVM experimentalEips(
      final BigInteger chainId, final SavmConfiguration savmConfiguration) {
    return experimentalEips(new SilaPragueGasCalculator(), chainId, savmConfiguration);
  }
  ...
  public static SAVM experimentalEips(
      ...
      final SavmConfiguration savmConfiguration) {
    return new SAVM(
        experimentalEipsOperations(gasCalculator, chainId, savmConfiguration),
        gasCalculator,
        savmConfiguration,
  ...
  private static OperationRegistry experimentalEipsOperations(
      ...
      final SavmConfiguration savmConfiguration) {
    OperationRegistry operationRegistry = new OperationRegistry();
    registerExperimentalEipsOperations(
  ...
  private static void registerExperimentalEipsOperations(
      ...
      final BigInteger chainID,
      final SavmConfiguration savmConfiguration) {
    registerFutureEipsOperations(registry, gasCalculator, chainID, savmConfiguration);
  }
}
