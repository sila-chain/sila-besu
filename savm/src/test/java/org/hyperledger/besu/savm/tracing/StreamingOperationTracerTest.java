...
class StreamingOperationTracerTest {
  ...
  @Test
  void sip3155ModifiedTestCaseStrictTypes() {

    ByteArrayOutputStream baos = new ByteArrayOutputStream();
    PrintStream out = new PrintStream(baos);
    var executor = new SAVMExecutor(SavmSpec.savmSpec(SavmSpecVersion.ISTANBUL));
    ...
    // differences from the SIP-3155 test case
    //  (a) the test case was written when SIP-2315 was part of the pending hard fork, so
