 ...
 */
package org.hyperledger.besu.savm.log;

import static org.assertj.core.api.Assertions.assertThat;
import static org.hyperledger.besu.savm.log.SIP7708TransferLogEmitter.BURN_TOPIC;
import static org.hyperledger.besu.savm.log.SIP7708TransferLogEmitter.SIP7708_SYSTEM_ADDRESS;
import static org.hyperledger.besu.savm.log.SIP7708TransferLogEmitter.TRANSFER_TOPIC;
...
class SIP7708TransferLogEmitterTest {
  ...
  void systemAddressIsCorrect() {
    assertThat(SIP7708_SYSTEM_ADDRESS)
  ...
  void createTransferLogHasCorrectStructure() {
    ...
    final Log log = SIP7708TransferLogEmitter.createTransferLog(SENDER, RECIPIENT, value);
  ...
  void createTransferLogWithZeroAddress() {
    ...
    final Log log = SIP7708TransferLogEmitter.createTransferLog(zeroAddress, RECIPIENT, value);
  ...
  void createTransferLogWithSmallValue() {
    ...
    final Log log = SIP7708TransferLogEmitter.createTransferLog(SENDER, RECIPIENT, smallValue);
  ...
  void createBurnLogHasCorrectStructure() {
    final Wei value = Wei.of(1000);
    final Log log = SIP7708TransferLogEmitter.createBurnLog(SENDER, value);
  ...
  void emitTransferLogDoesNotEmitForSelfTransfer() {
    ...
    SIP7708TransferLogEmitter.INSTANCE.emitTransferLog(frame, SENDER, SENDER, value);
  ...
  void emitTransferLogEmitsForTransferToDifferentAddress() {
    ...
    SIP7708TransferLogEmitter.INSTANCE.emitTransferLog(frame, SENDER, RECIPIENT, value);
  ...
  void emitTransferLogDoesNotEmitForZeroValue() {
    ...
    SIP7708TransferLogEmitter.INSTANCE.emitTransferLog(frame, SENDER, RECIPIENT, Wei.ZERO);
  ...
  void emitSelfDestructLogEmitsBurnLogWhenOriginatorEqualsBeneficiary() {
    ...
    SIP7708TransferLogEmitter.INSTANCE.emitSelfDestructLog(frame, SENDER, SENDER, value);
  ...
  void emitSelfDestructLogEmitsTransferLogWhenOriginatorDifferentFromBeneficiary() {
    ...
    SIP7708TransferLogEmitter.INSTANCE.emitSelfDestructLog(frame, SENDER, RECIPIENT, value);
  ...
  void emitSelfDestructLogDoesNotEmitForZeroValue() {
    ...
    SIP7708TransferLogEmitter.INSTANCE.emitSelfDestructLog(frame, SENDER, RECIPIENT, Wei.ZERO);
  ...
  void emitClosureLogsEmitsLogsInLexicographicalOrder() {
    ...
    SIP7708TransferLogEmitter.INSTANCE.emitClosureLogs(
