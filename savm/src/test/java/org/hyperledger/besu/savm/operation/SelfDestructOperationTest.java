...
public class SelfDestructOperationTest {
  ...
  private final SelfDestructOperation sip6780Operation =
  ...
  void checkContractDeletionCommon(
    ...
    final Operation.OperationResult operationResult = operation.execute(messageFrame, savm);
  ...
  void checkContractDeletionEIP6780(
      ...
      final boolean newAccount,
      final String balanceHex) {
    checkContractDeletionCommon(originator, beneficiary, balanceHex, newAccount, sip6780Operation);
