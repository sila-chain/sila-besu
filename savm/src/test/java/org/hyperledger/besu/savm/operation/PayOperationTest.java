...
public class PayOperationTest {
  ...
  private static final SAVM SAVM_INSTANCE = mock(SAVM.class);
  ...
  void noValueTest(
    ...
    final PayOperation operation = new PayOperation(new SilaOsakaGasCalculator());
    ...
    var result = operation.execute(frame, SAVM_INSTANCE);
