 ...
 */
package org.hyperledger.besu.savm.testutils;
...
/** ByteCodeBuilder is a helper class to aid in construction of SAVM bytecode for tests */
public class ByteCodeBuilder {
  ...
  /**
   * Operation to push the value to the SAVM stack
   *
