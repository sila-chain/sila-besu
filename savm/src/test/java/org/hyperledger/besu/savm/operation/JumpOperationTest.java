...
class JumpOperationTest {
  ...
  void shouldJumpWhenLocationIsJumpDest() {
    ...
    final OperationResult result = operation.execute(frame, savm);
  ...
  void shouldHaltWithInvalidJumDestinationWhenLocationIsOutsideOfCodeRange() {
    ...
    final OperationResult result = operation.execute(frameDestinationGreaterThanCodeSize, savm);
    ...
    final OperationResult result2 = operation.execute(frameDestinationEqualsToCodeSize, savm);
  ...
  void longContractsValidate() {
    ...
    final OperationResult result = operation.execute(longContract, savm);
    assertThat(result.getHaltReason()).isNull();
  }
}
