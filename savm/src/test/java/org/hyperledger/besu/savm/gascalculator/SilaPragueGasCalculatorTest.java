...
class SilaPragueGasCalculatorTest {
  ...
  void testPrecompileSize() {
    SilaPragueGasCalculator subject = new SilaPragueGasCalculator();
  ...
  void shouldCalculateRefundWithMultipleSelfDestructs() {
    ...
    // Assert
    // execution refund = 1000 + 0 (self destructs SIP-3529) + 1000 (code delegation) = 2000
    AssertionsForClassTypes.assertThat(refund)
