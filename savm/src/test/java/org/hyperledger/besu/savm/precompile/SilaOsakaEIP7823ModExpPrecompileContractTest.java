...
import static org.hyperledger.besu.savm.precompile.BigIntegerModularExponentiationPrecompiledContract.disableNative;
import static org.hyperledger.besu.savm.precompile.BigIntegerModularExponentiationPrecompiledContract.maybeEnableNative;
...
class SilaOsakaEIP7823ModExpPrecompiledContractTest {

  private static final Random RANDOM = new Random();
  @Mock private MessageFrame messageFrame;

  private final PrecompiledContract pragueContract =
      SavmSpec.savmSpec(SavmSpecVersion.PRAGUE).getPrecompileContractRegistry().get(Address.MODEXP);
  private final PrecompiledContract osakaContract =
      SavmSpec.savmSpec(SavmSpecVersion.OSAKA).getPrecompileContractRegistry().get(Address.MODEXP);
