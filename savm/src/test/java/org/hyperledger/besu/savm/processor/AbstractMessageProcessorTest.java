...
import static org.hyperledger.besu.savm.processor.AbstractMessageProcessorTest.ContextTracer.TRACE_TYPE.CONTEXT_ENTER;
import static org.hyperledger.besu.savm.processor.AbstractMessageProcessorTest.ContextTracer.TRACE_TYPE.CONTEXT_EXIT;
import static org.hyperledger.besu.savm.processor.AbstractMessageProcessorTest.ContextTracer.TRACE_TYPE.CONTEXT_RE_ENTER;
import static org.hyperledger.besu.savm.processor.AbstractMessageProcessorTest.ContextTracer.TRACE_TYPE.POST_EXECUTION;
import static org.hyperledger.besu.savm.processor.AbstractMessageProcessorTest.ContextTracer.TRACE_TYPE.PRE_EXECUTION;
...
import org.hyperledger.besu.savm.fluent.SAVMExecutor;
...
abstract class AbstractMessageProcessorTest<T extends AbstractMessageProcessor> {
  ...
  void shouldTraceContextEnterExitForEip3155Test() {
    ...
    /*
     The byte code below is taken from https://sips.sila.org/SIPS/sip-3155
