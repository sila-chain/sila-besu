...
class SwapNOperationTest {
  ...
  private final SwapNOperation operation = new SwapNOperation(new SilaPragueGasCalculator());
  ...
  void testSpecVector_jumpOverInvalid() {
    ...
    // In SAVM, the 0x5b at position 4 is valid as JUMPDEST when jumped to directly
