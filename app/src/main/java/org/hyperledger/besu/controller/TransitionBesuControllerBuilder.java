...
public class TransitionBesuControllerBuilder extends BesuControllerBuilder {
  ...
  public BesuControllerBuilder savmConfiguration(final SavmConfiguration savmConfiguration) {
    super.savmConfiguration(savmConfiguration);
    return propagateConfig(z -> z.savmConfiguration(savmConfiguration));
  }
  ...
  public BesuControllerBuilder silProtocolConfiguration(
    ...
    super.silProtocolConfiguration(silProtocolConfiguration);
    return propagateConfig(z -> z.silProtocolConfiguration(silProtocolConfiguration));
  }
