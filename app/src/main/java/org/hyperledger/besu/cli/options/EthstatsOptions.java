...
public class EthstatsOptions implements CLIOptions<SilStatsConnectOptions> {

  private static final String SILSTATS = "--ethstats";
  private static final String SILSTATS_CONTACT = "--ethstats-contact";
  private static final String SILSTATS_CACERT_FILE = "--ethstats-cacert-file";
  private static final String SILSTATS_REPORT_INTERVAL = "--ethstats-report-interval";
  ...
  public List<String> getCLIOptions() {
    ...
    options.add(SILSTATS + "=" + ethstatsUrl);
    options.add(SILSTATS_CONTACT + "=" + ethstatsContact);
    if (ethstatsCaCert != null) {
      options.add(SILSTATS_CACERT_FILE + "=" + ethstatsCaCert);
    }
    options.add(SILSTATS_REPORT_INTERVAL + "=" + ethstatsReportInterval);
    return options;
  }
}
