...
public class TransactionPoolOptions implements CLIOptions<TransactionPoolConfiguration> {
  ...
  @CommandLine.Option(
      ...
      paramLabel = "<Boolean>",
      description =
          "Require transactions submitted via JSON-RPC to use replay protection in accordance with SIP-155 (default: ${DEFAULT-VALUE})",
      fallbackValue = "true",
      arity = "0..1")
  ...
  static class Unstable {
    ...
    @CommandLine.Option(
        names = {SIL65_TX_ANNOUNCED_BUFFERING_PERIOD_FLAG},
        paramLabel = "<LONG>",
    ...
    private Duration sil65TrxAnnouncedBufferingPeriod =
  ...
  public static TransactionPoolOptions fromConfig(final TransactionPoolConfiguration config) {
    ...
    options.unstableOptions.sil65TrxAnnouncedBufferingPeriod =
        config.getUnstable().getSil65TrxAnnouncedBufferingPeriod();
    ...
    return ImmutableTransactionPoolConfiguration.builder()
        ...
        .unstable(
            ImmutableTransactionPoolConfiguration.Unstable.builder()
                ...
                .sil65TrxAnnouncedBufferingPeriod(unstableOptions.sil65TrxAnnouncedBufferingPeriod)
