...
import static org.hyperledger.besu.sila.core.MiningConfiguration.DEFAULT_PLUGIN_BLOCK_TXS_SELECTION_MAX_TIME;
import static org.hyperledger.besu.sila.core.MiningConfiguration.DEFAULT_POA_BLOCK_TXS_SELECTION_MAX_TIME;
import static org.hyperledger.besu.sila.core.MiningConfiguration.DEFAULT_POS_BLOCK_TXS_SELECTION_MAX_TIME;
import static org.hyperledger.besu.sila.core.MiningConfiguration.MutableInitValues.DEFAULT_EXTRA_DATA;
import static org.hyperledger.besu.sila.core.MiningConfiguration.MutableInitValues.DEFAULT_MIN_PRIORITY_FEE_PER_GAS;
import static org.hyperledger.besu.sila.core.MiningConfiguration.MutableInitValues.DEFAULT_MIN_TRANSACTION_GAS_PRICE;
import static org.hyperledger.besu.sila.core.MiningConfiguration.Unstable.DEFAULT_POS_BLOCK_CREATION_MAX_TIME;
import static org.hyperledger.besu.sila.core.MiningConfiguration.Unstable.DEFAULT_POS_BLOCK_CREATION_REPETITION_MIN_DURATION;
import static org.hyperledger.besu.sila.core.MiningConfiguration.Unstable.DEFAULT_POS_BLOCK_FINALIZATION_TIMEOUT_MS;
import static org.hyperledger.besu.sila.core.MiningConfiguration.Unstable.DEFAULT_POS_SLOT_DURATION_SECS;
  ...
  @Option(
      ...
      description =
          "Maximum number of blobs allowed per transaction. "
              + "Only applies from SilaOsaka hardfork onwards. (default: 6)",
      arity = "1")
  ...
  @Option(
      ...
      description =
          "Maximum number of blobs allowed per block when building blocks. "
              + "Only applies from SilaOsaka hardfork onwards. Values above the protocol maximum are clamped. (default: protocol maximum)",
      arity = "1")
