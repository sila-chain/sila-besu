...
public class ConfigurationOverviewBuilder {
  ...
  public ConfigurationOverviewBuilder setWorldStateUpdateMode(
      final SavmConfiguration.WorldUpdaterMode worldStateUpdateMode) {
   ...
   *
   * @param savmV2 true if --Xsavm-go-fast / --Xsavm-v2 is enabled
   * @return the builder
   */
  public ConfigurationOverviewBuilder setSavmV2(final boolean savmV2) {
    this.savmV2 = savmV2;
    return this;
  }
  ...
  public String build() {
    ...
    if (savmV2) {
      lines.add("Experimental SAVM v2 (long[] stack) enabled");
    } else {
