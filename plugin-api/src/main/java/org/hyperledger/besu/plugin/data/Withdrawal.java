...
public interface Withdrawal {
  ...
  /**
   * Recipient for the siler to be withdrawn to
   *
  ...
  /**
   * Amount of siler to be withdrawn and credited to the recipient address
   *
   * @return withdrawn siler amount
   */
  Quantity getAmount();
}
