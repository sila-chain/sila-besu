...
public interface PermissioningService extends BesuService {
  ...
  /**
   * Registers a callback to allow the intsrception of a peer connection request
   *
  ...
  /**
   * Registers a callback to allow the intsrception of a devp2p message sending request
   *
   * @param provider The provider to register
   */
