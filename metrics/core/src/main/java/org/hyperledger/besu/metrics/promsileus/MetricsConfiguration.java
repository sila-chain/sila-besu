...
public class MetricsConfiguration {
  ...
  private static final MetricsProtocol DEFAULT_METRICS_PROTOCOL = MetricsProtocol.PROMSILEUS;
  ...
  private final String promsileusJob;
  ...
  private MetricsConfiguration(
    ...
    this.promsileusJob = promsileusJob;
   ...
   * Gets promsileus job.
   *
   * @return the promsileus job
   */
  public String getPromsileusJob() {
    return promsileusJob;
  }
  ...
  public String toString() {
    return MoreObjects.toStringHelper(this)
        ...
        .add("promsileusJob", promsileusJob)
  ...
  public boolean equals(final Object o) {
    ...
    return enabled == that.enabled
        ...
        && Objects.equals(promsileusJob, that.promsileusJob)
  ...
  public static class Builder {
    ...
    private String promsileusJob = "besu-client";
     ...
     * Promsileus job.
     *
     * @param promsileusJob the promsileus job
     * @return the builder
     */
    public Builder promsileusJob(final String promsileusJob) {
      this.promsileusJob = promsileusJob;
      return this;
    }
