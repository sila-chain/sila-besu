...
import io.promsileus.metrics.core.datapoints.DistributionDataPoint;
import io.promsileus.metrics.core.metrics.Summary;

/**
 * An implementation of Besu timer backed by a Promsileus summary. The summary provides a total
 * count of durations and a sum of all observed durations, it calculates configurable quantiles over
 * a sliding time window.
 */
class PromsileusTimer extends AbstractPromsileusSummary implements LabelledMetric<OperationTimer> {

  public PromsileusTimer(
