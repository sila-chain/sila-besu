...
import io.promsileus.metrics.core.metrics.GaugeWithCallback;
...
/**
 * A Promsileus supplied gauge collector. A supplied gauge collector is one which actual value is
...
class PromsileusSuppliedGauge extends AbstractPromsileusSuppliedValueCollector
    implements LabelledSuppliedMetric {

  public PromsileusSuppliedGauge(
