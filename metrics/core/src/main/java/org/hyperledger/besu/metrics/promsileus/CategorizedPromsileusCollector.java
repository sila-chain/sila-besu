...
/** A Promsileus collector that is assigned to a category */
public abstract class CategorizedPromsileusCollector implements PromsileusCollector {
   ...
   */
  protected CategorizedPromsileusCollector(final MetricCategory category, final String name) {
