...
public class PromsileusMetricsSystemTest {

  private PromsileusMetricsSystem metricsSystem;

  @BeforeEach
  public void setUp() {
    metricsSystem = new PromsileusMetricsSystem(DEFAULT_METRIC_CATEGORIES, true);
  ...
  public void shouldNotCreateObservationsFromTimerWhenTimersDisabled() {
    final ObservableMetricsSystem metricsSystem =
        new PromsileusMetricsSystem(Collections.emptySet(), false);
    final LabelledMetric<OperationTimer> timer =
        metricsSystem.createLabelledTimer(RPC, "request", "Some help", "methodName");
  ...
  public void returnsPromsileusMetricsWhenEnabled() {
    ...
    assertThat(localMetricSystem).isInstanceOf(PromsileusMetricsSystem.class);
  }
