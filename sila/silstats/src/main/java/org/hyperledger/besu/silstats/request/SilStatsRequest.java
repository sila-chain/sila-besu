 ...
 */
package org.hyperledger.besu.silstats.request;
...
/**
 * This class represents an Sila statistics request. It provides methods to get the type of the
 * request and the parameters associated with it.
 */
public class SilStatsRequest {
  ...
  private SilStatsRequest() {}

  /**
   * Constructs a new SilStatsRequest with the given type and parameters.
   *
   * @param type the type of the request
   * @param parameters the parameters of the request
   */
  public SilStatsRequest(final Type type, final Object... parameters) {
  ...
  /**
   * Creates an SilStatsRequest from a response string.
   *
   * @param value the response string
   * @return the SilStatsRequest
   */
  public static SilStatsRequest fromResponse(final String value) {
    try {
      return MAPPER.readValue(value, SilStatsRequest.class);
    } catch (JsonProcessingException e) {
      return new SilStatsRequest(Type.UNKNOWN);
    }
  }
