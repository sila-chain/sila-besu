 ...
 * SIP-7928 item budget to {@link BlockAccessListValidator#validateExecutedBlockAccessListItemSize};
...
class BlockAccessListItemBudgetTransactionSelectorTest {
  ...
  /**
   * This selector never applies the SIP-7928 item budget in the pre-processing phase, so a
  ...
  /**
   * Empty committed BAL + partial adding two SIP-7928 items: the probe item count passed to the
  ...
  /** One account + one storage write → 2 SIP-7928 items (same shape as other BAL tests). */
