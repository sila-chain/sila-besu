...
/**
 * SIP-7928 BAL item budget during block building requires SilaAmsterdam (or later); this class is
...
class SilaAmsterdamBalBlockTransactionSelectorTest {
  ...
  void secondTransactionNotSelectedWhenBlockAccessListItemBudgetWouldBeExceeded() {
    ...
    assertThat(committedBal.sip7928ItemCount()).isEqualTo(2);
