...
import org.hyperledger.besu.sila.rlp.util.RLPTestUtil;
...
/** The Sila reference RLP tests. */
public class InvalidRLPRefTest {

  private static final String[] TEST_CONFIG_FILES = {
    // TODO: upstream these additional tests to the sila tests repo
    "org/hyperledger/besu/sila/rlp/invalidRLPTest.json", "RLPTests/invalidRLPTest.json"
  };
