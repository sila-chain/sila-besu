...
import org.hyperledger.besu.sila.p2p.discovery.discv4.internal.DevP2PException;
import org.hyperledger.besu.sila.p2p.discovery.discv4.internal.packet.PacketDataDeserializer;
import org.hyperledger.besu.sila.rlp.MalformedRLPInputException;
...
public class PingPacketDataRlpReader implements PacketDataDeserializer<PingPacketData> {
  ...
  public PingPacketData readFrom(final RLPInput in) {
    in.enterList();
    // The first element signifies the "version", but this value is ignored as of SIP-8
