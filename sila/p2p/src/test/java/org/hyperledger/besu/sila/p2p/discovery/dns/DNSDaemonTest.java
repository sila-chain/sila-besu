...
class DNSDaemonTest {
  ...
  private static final String holeskyEnr =
      "enrtree://AKA3AM6LPBYEUDMVNU3BSVQJ5AD45Y7YPOHJLEF6W26QOE4VTUDPE@all.holesky.sildisco.net";
  ...
  void invalidEnrShouldNotCrashDaemon(final Vertx vertx, final VertxTestContext testContext) {
    ...
    mockDnsServerVerticle.addTxtRecord(
        "FDXN3SN67NA5DKA4J2GOK7BVQI.all.holesky.sildisco.net",
    ...
    mockDnsServerVerticle.addTxtRecord(
        "I56MJAJBMXTZZEPBQR6HWNAH7A.all.holesky.sildisco.net", "enr:-Lu4QMFaK");

    // empty ENR record
    mockDnsServerVerticle.addTxtRecord(
        "I56GAAJBMXTZZEPBQR6HWNAH7A.all.holesky.sildisco.net", "enr:");

    // invalid IP field in ENR record
    mockDnsServerVerticle.addTxtRecord(
        "I56HGDJBMXTZZEPBQR6HWNAH7A.all.holesky.sildisco.net",
