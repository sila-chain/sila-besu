...
import org.hyperledger.besu.sila.p2p.SilProtocolHelper;
...
import org.hyperledger.besu.sila.p2p.network.exceptions.UnexpectedPeerConnectionException;
...
import org.hyperledger.besu.sila.p2p.rlpx.connections.netty.testhelpers.NettyMocks;
import org.hyperledger.besu.sila.p2p.rlpx.framing.Framer;
...
import org.hyperledger.besu.sila.p2p.rlpx.wire.MockSubProtocol;
...
public class DeFramerTest {
  ...
  private final List<Capability> capabilities = Arrays.asList(SilProtocolHelper.LATEST);
  ...
  public void decode_handlesNoSharedCaps() {
    ...
    final PeerInfo remotePeerInfo =
        new PeerInfo(
            p2pVersion, "bla", Arrays.asList(Capability.create("sil", 254)), 30303, nodeId);
  ...
  private DeFramer createDeFramer(
    ...
    return new DeFramer(
        framer,
        Arrays.asList(MockSubProtocol.create("sil")),
        localNode,
