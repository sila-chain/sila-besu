...
public class BlockHeader extends SealableBlockHeader
  ...
  public static org.hyperledger.besu.sila.core.BlockHeader convertPluginBlockHeader(
      final org.hyperledger.besu.plugin.data.BlockHeader pluginBlockHeader,
      final BlockHeaderFunctions blockHeaderFunctions) {
    return new org.hyperledger.besu.sila.core.BlockHeader(
