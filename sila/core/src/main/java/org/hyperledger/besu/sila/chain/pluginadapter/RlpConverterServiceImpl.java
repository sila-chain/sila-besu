...
public class RlpConverterServiceImpl implements RlpConverterService {
  ...
  public BlockHeader buildHeaderFromRlp(final Bytes rlp) {
    return org.hyperledger.besu.sila.core.BlockHeader.readFrom(
        RLP.input(rlp), blockHeaderFunctions);
  }

  @Override
  public BlockBody buildBodyFromRlp(final Bytes rlp) {
    return org.hyperledger.besu.sila.core.BlockBody.readWrappedBodyFrom(
        RLP.input(rlp), blockHeaderFunctions);
  }
  ...
  public Bytes buildRlpFromHeader(final BlockHeader blockHeader) {
    return RLP.encode(
        org.hyperledger.besu.sila.core.BlockHeader.convertPluginBlockHeader(
    ...
    return RLP.encode(
        rlpOutput ->
            TransactionReceiptEncoder.writeTo(
                (org.hyperledger.besu.sila.core.TransactionReceipt) receipt,
                rlpOutput,
