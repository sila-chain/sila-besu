...
/**
 * Outcome of {@link BlockAccessListValidator#validateExecutedBlockAccessListItemSize} (SIP-7928
...
public sealed interface BlockAccessListItemSizeCheck
  ...
  /** {@code true} when the running item count exceeds the SIP-7928 budget for the header. */
