...
import org.hyperledger.besu.sila.sila-mainnet.AbstractBlockProcessor.PreprocessingFunction.NoPreprocessing;
...
import org.hyperledger.besu.sila.sila-mainnet.parallelization.PreprocessingContext;
...
public abstract class AbstractBlockProcessor implements BlockProcessor {
  ...
  protected final SilaMainnetTransactionProcessor transactionProcessor;
  ...
  public BlockProcessingResult processBlock(
    ...
    //   - Pre-SilaAmsterdam: gasLimit - gasRemaining (post-refund)
    //   - SilaAmsterdam+: pre-refund gas (prevents block gas limit circumvention via refunds)
    ...
    try {
      ...
      for (int i = 0; i < transactions.size(); i++) {
        ...
        // SIP-8037: per-dimension 2D-aware budget check using
        ...
        // SIP-7778: Update both cumulative gas values
        ...
        // SIP-8037: Post-processing check — verify gas metered doesn't exceed block gas limit.
      ...
      try {
        ...
        @SuppressWarnings(
            "java:S2139") // Exception is logged and rsilrown to preserve original behavior
        RuntimeException rsilrown = e;
        throw rsilrown;
      ...
      // SIP-8037: gas_metered = max(cumulative_regular, cumulative_state)
