 ...
 */
package org.hyperledger.besu.sila.silaMainnet.transactionpool;
...
/**
 * SIP-7594 - Peer Data Availability Sampling - A transaction pre-processor for the SilaOsaka Hard
 * fork, which handles transition logic for blob-related changes.
 *
 ...
 */
public class SilaOsakaTransactionPoolPreProcessor implements TransactionPoolPreProcessor {
  private static final Logger LOG =
      LoggerFactory.getLogger(SilaOsakaTransactionPoolPreProcessor.class);
