...
public class ProtocolSpec {
   ...
   * @param savm the SAVM supporting the appropriate operations for this specification
   ...
   * @param slotNumberRequired whether block headers of this fork must carry the SIP-7843 slot
   *     number
   ...
   */
  public SilaMainnetTransactionProcessor getTransactionProcessor() {
  ...
  /**
   * Returns the SAVM for this specification.
   *
   * @return the SAVM
   */
  public SAVM getEvm() {
  ...
  /**
   * Sometimes we apply zero block rewards to the Trie (pre SIP158) sometimes we don't (post SIP158
  ...
  /**
   * Whether headers of this fork must carry the SIP-7843 {@code slotNumber}. Block creation
   * consults it so a locally built header is not rejected by this fork's own validation.
   *
   * @return true from SilaAmsterdam onwards
   */
