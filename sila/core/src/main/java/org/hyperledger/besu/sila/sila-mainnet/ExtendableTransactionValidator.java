...
/**
 * Validates a transaction based on sila-mainnet rule and other custom rules that can be added by
 * plugins. Note that custom validation rules can only be more restrictive and standard sila-mainnet
