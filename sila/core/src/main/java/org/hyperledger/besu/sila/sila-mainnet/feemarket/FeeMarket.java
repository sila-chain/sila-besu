 ...
 */
package org.hyperledger.besu.sila.sila-mainnet.feemarket;

import org.hyperledger.besu.config.BlobSchedule;
import org.hyperledger.besu.datatypes.BlobGas;
import org.hyperledger.besu.datatypes.Wei;
import org.hyperledger.besu.sila.core.Transaction;
import org.hyperledger.besu.sila.core.feemarket.TransactionPriceCalculator;
...
public interface FeeMarket {
  ...
  /**
   * Indicates whether the fee market implements the base fee mechanism (e.g., SIP-1559).
   *
  ...
  /**
   * Creates a Blob fee market with default SilaCancun blob schedule parameters.
   *
   * @param londonForkBlockNumber the block number at which the London fork activates.
   * @param baseFeePerGasOverride an optional override for the base fee per gas.
   * @return a {@link BaseFeeMarket} instance for the SilaCancun fork with default blob schedule.
   */
  @VisibleForTesting
   ...
   * @return a {@link BaseFeeMarket} instance for the SilaCancun fork.
   */
