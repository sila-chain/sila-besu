...
import org.hyperledger.besu.sila.sila-mainnet.milestones.MilestoneDefinition;
import org.hyperledger.besu.sila.sila-mainnet.milestones.MilestoneDefinitions;
import org.hyperledger.besu.sila.sila-mainnet.milestones.MilestoneType;
    ...
    final SilaMainnetProtocolSpecFactory specFactory =
        new SilaMainnetProtocolSpecFactory(
            ...
            savmConfiguration.overrides(
                config.getContractSizeLimit(), OptionalInt.empty(), config.getSavmStackSize()),
            miningConfiguration,
