...
import org.hyperledger.besu.sila.silaMainnet.AbstractBlockProcessor.PreprocessingFunction.NoPreprocessing;
...
import org.hyperledger.besu.sila.silaMainnet.parallelization.PreprocessingContext;
...
public abstract class AbstractBlockProcessor implements BlockProcessor {
  ...
  public BlockProcessingResult processBlock(
    ...
    try {
      ...
      // SIP-8037: gas_metered = max(cumulative_execution, cumulative_state)
