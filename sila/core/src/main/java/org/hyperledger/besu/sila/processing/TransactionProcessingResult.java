...
public class TransactionProcessingResult
   ...
   * standard behavior for pre-SilaAmsterdam forks where block gas accounting uses post-refund gas.
   */
  public static TransactionProcessingResult failed(
      final long gasUsedByTransaction,
      final long gasRemaining,
  ...
  /**
   * Constructor without gasSpent (for pre-SilaAmsterdam forks). Defaults gasSpent to
   ...
   *
   * <p>SIP-7778: This value is now tracked separately from the gas used for block accounting
  ...
  /**
   * Returns the state gas used by the transaction (SIP-8037).
   *
