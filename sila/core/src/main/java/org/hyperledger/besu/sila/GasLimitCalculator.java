...
public interface GasLimitCalculator {
  ...
  /**
   * The constant BLOB_GAS_LIMIT represents the gas limit for blob data. Defaults to the SilaCancun
   * value where it was first introduced as part of SIP-4844
   */
  ...
  /**
   * Retrieves the target blob gas per block. Added in SilaCancun.
   *
   ...
   *
   * <p>Before SilaOsaka, there was no limit, the max number of blobs a transaction could have was
