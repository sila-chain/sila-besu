...
public class SilaCancunPreExecutionProcessor extends FrontierPreExecutionProcessor {
  private static final Logger LOG = LoggerFactory.getLogger(SilaCancunPreExecutionProcessor.class);
  ...
  private void process(
    ...
    try {
      ...
      // According to SIP-4788, fail silently if no code exists
