...
import org.hyperledger.besu.sila.core.encoding.AccessListTransactionEncoder;
import org.hyperledger.besu.sila.core.encoding.BlobTransactionEncoder;
import org.hyperledger.besu.sila.core.encoding.CodeDelegationTransactionEncoder;
...
public class Transaction
   ...
   *
   * @param maybeBaseFee base fee in case of SIP-1559 transaction
  ...
  public BigInteger getV() {
    if (transactionType != null && transactionType != TransactionType.FRONTIER) {
      // SIP-2718 typed transaction, use yParity:
      return null;
    } else {
  ...
  public BigInteger getYParity() {
    if (transactionType != null && transactionType != TransactionType.FRONTIER) {
      // SIP-2718 typed transaction, return yParity:
  ...
  private static Bytes sip1559Preimage(
      final long nonce,
      final Wei maxPriorityFeePerGas,
      final Wei maxFeePerGas,
      final long gasLimit,
    ...
    return Bytes.concatenate(Bytes.of(TransactionType.SIP1559.getSerializedType()), encoded);
  }

  private static void sip1559PreimageFields(
      final long nonce,
      final Wei maxPriorityFeePerGas,
      final Wei maxFeePerGas,
      final long gasLimit,
