...
public class SilaOsakaTargetingGasLimitCalculator extends SilaCancunTargetingGasLimitCalculator {
  private static final Logger LOG = LoggerFactory.getLogger(SilaOsakaTargetingGasLimitCalculator.class);

  /**
   * The SIP-7825 transaction gas limit cap value (2^24). Through SilaOsaka this caps {@code tx.gas}
   * itself; SIP-8037 (SilaAmsterdam) repurposes the same value as the cap on {@code
   * max(intrinsic_regular, calldata_floor)}. See {@link #transactionGasLimitCap()} and {@link
   * #transactionIntrinsicGasLimitCap()}.
   */
  public static final long SIP_7825_TRANSACTION_GAS_LIMIT_CAP = 16_777_216L;

  /** The constant max number of blobs per transaction defined for SilaOsaka */
  private static final int DEFAULT_MAX_BLOBS_PER_TRANSACTION = 6;

  /** The blob base cost constant for SilaOsaka */
  ...
  public SilaOsakaTargetingGasLimitCalculator(
    ...
    this(
        ...
        SIP_7825_TRANSACTION_GAS_LIMIT_CAP);
  }
