 ...
 */
package org.hyperledger.besu.sila.sila-mainnet.blockhash;
...
import org.hyperledger.besu.sila.sila-mainnet.systemcall.SystemCallNoCodeAtAddressException;
import org.hyperledger.besu.sila.sila-mainnet.systemcall.SystemCallProcessor;
...
/**
 * Processes and stores historical block hashes in accordance with SIP-2935. This class is
 * responsible for managing the storage of block hashes to support SIP-2935, which introduces
 * historical block hash access in smart contracts.
 */
public class SilaPraguePreExecutionProcessor extends SilaCancunPreExecutionProcessor {
  private static final Logger LOG = LoggerFactory.getLogger(SilaPraguePreExecutionProcessor.class);
  ...
  /** Constructs a SilaPraguePreExecutionProcessor. */
  public SilaPraguePreExecutionProcessor() {
    this(HISTORY_STORAGE_ADDRESS);
  }

  /**
   * Constructs a SilaPraguePreExecutionProcessor with a specified history save window. This constructor
   * is primarily used for testing.
   *
   * @param historyStorageAddress the address of the contract storing the history
   */
  @VisibleForTesting
  public SilaPraguePreExecutionProcessor(final Address historyStorageAddress) {
  ...
  public Void process(
    ...
    try {
      ...
      // According to SIP-2935, the system call should fail silently if no code exists at the
      // contract address
