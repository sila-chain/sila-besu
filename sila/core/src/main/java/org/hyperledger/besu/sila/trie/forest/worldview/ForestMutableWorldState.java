...
public class ForestMutableWorldState implements MutableWorldState {
  ...
  public ForestMutableWorldState(
      final WorldState worldState, final SavmConfiguration savmConfiguration) {
  ...
  public WorldUpdater updater() {
    return new Updater(this, savmConfiguration);
  }
  ...
  protected static class Updater
    ...
    protected Updater(
        final ForestMutableWorldState world, final SavmConfiguration savmConfiguration) {
