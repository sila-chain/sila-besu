...
/** Provides the various difficultly calculates used on sila-mainnet hard forks. */
public abstract class SilaMainnetDifficultyCalculators {
  ...
  private SilaMainnetDifficultyCalculators() {}
  ...
  // As per https://sips.sila.org/SIPS/sip-5133
