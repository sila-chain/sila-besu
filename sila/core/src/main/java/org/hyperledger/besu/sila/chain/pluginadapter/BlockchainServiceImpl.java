 ...
 */
package org.hyperledger.besu.sila.chain.pluginadapter;
...
public class BlockchainServiceImpl implements BlockchainService {
  ...
  public void storeBlock(
    ...
    final org.hyperledger.besu.sila.core.BlockHeader coreHeader =
        (org.hyperledger.besu.sila.core.BlockHeader) blockHeader;
    final org.hyperledger.besu.sila.core.BlockBody coreBody =
        (org.hyperledger.besu.sila.core.BlockBody) blockBody;
    final List<org.hyperledger.besu.sila.core.TransactionReceipt> coreReceipts =
        receipts.stream()
            .map(org.hyperledger.besu.sila.core.TransactionReceipt.class::cast)
            .toList();
  ...
  // Same matching rules as sil_getLogs: any address when the list is empty, topics matched by
