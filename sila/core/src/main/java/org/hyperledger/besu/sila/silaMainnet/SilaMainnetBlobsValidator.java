...
import static org.hyperledger.besu.sila.core.kzg.CKZG4844Helper.verify4844Kzg;
 ...
 */
public class SilaMainnetBlobsValidator {
  final Set<BlobType> acceptedBlobVersions;
  final GasLimitCalculator gasLimitCalculator;
  final GasCalculator gasCalculator;

  /**
   * Creates a new {@link SilaMainnetBlobsValidator}.
   *
   ...
   */
  public SilaMainnetBlobsValidator(
      final Set<BlobType> acceptedBlobVersions,
      final GasLimitCalculator gasLimitCalculator,
      final GasCalculator gasCalculator) {
