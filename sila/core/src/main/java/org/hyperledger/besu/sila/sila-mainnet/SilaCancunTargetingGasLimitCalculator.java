...
public class SilaCancunTargetingGasLimitCalculator extends LondonTargetingGasLimitCalculator {
  ...
  /**
   * Using SilaCancun sila-mainnet default of 6 blobs for maxBlobsPerBlock: getBlobGasPerBlob() * 6 blobs =
   * 131072 * 6 = 786432 = 0xC0000
   */
  public SilaCancunTargetingGasLimitCalculator(
