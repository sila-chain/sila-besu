...
/**
 * SilaMainnet implementation of BlockAccessListValidator that validates block access lists
 * according to SIP-7928.
 */
public class SilaMainnetBlockAccessListValidator implements BlockAccessListValidator {

  private static final Logger LOG =
      LoggerFactory.getLogger(SilaMainnetBlockAccessListValidator.class);
