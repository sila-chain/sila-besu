...
/**
 * SilaMainnet implementation of BlockAccessListValidator that validates block access lists according to
 * SIP-7928.
 */
public class SilaMainnetBlockAccessListValidator implements BlockAccessListValidator {

  private static final Logger LOG = LoggerFactory.getLogger(SilaMainnetBlockAccessListValidator.class);

  private final ProtocolSchedule protocolSchedule;

  /**
   * Creates a block access list validator for the given protocol schedule and optional BAL factory.
   * Use as method reference: {@code SilaMainnetBlockAccessListValidator::create}.
   *
  ...
  public static BlockAccessListValidator create(final ProtocolSchedule protocolSchedule) {
    return new SilaMainnetBlockAccessListValidator(protocolSchedule);
  }

  /**
   * Creates a new SilaMainnetBlockAccessListValidator.
   *
   * @param protocolSchedule the protocol schedule to get protocol specs from
   */
  public SilaMainnetBlockAccessListValidator(final ProtocolSchedule protocolSchedule) {
  ...
  public boolean validate(
    ...
    final BlockAccessListItemSizeCheck lightSizeCheck =
        validateExecutedBlockAccessListItemSize(
            bal.sip7928ItemCount(), blockHeader, protocolSchedule.getByBlockHeader(blockHeader));
  ...
  /**
   * Validates index range (indices in [0, maxIndex]) and canonical ordering (SIP-7928) in one
