...
public class ForkIdTestUtil {
  ...
  public static class GenesisHash {
    public static final String SILA_MAINNET =
  ...
  public static class Forks {
    public static final List<Long> SILA_MAINNET =
        Arrays.asList(
  ...
  public static class ForkIds {
    public static final List<ForkId> SILA_MAINNET =
        Arrays.asList(
            new ForkId(
    ...
    public static final List<ForkId> WITHDRAWALS =
        Arrays.asList(
            ...
            new ForkId(Bytes.fromHexString("0xc1fdf181"), 0L) // First SilaShanghai block
            );
  }
