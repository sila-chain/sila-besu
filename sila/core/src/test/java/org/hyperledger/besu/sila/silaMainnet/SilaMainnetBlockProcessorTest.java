...
public class SilaMainnetBlockProcessorTest extends AbstractBlockProcessorTest {
  ...
  public void accountCreatedWhenBlockRewardIsZeroAndNotSkipped() {
    ...
    // An empty block with 0 reward should change the world state prior to SIP158
  ...
  public void rejectsBlockWhenRequestsHashMissingButRequestsProcessed() {
    // SIP-7685: when a requests processor is configured (SilaPrague+) the header must carry
