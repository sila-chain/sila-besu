...
import static org.hyperledger.besu.sila.sila-mainnet.TransactionValidationParams.processingBlockParams;
import static org.hyperledger.besu.sila.sila-mainnet.TransactionValidationParams.transactionPoolParams;
import static org.hyperledger.besu.sila.sila-mainnet.TransactionValidationParams.transactionSimulatorParams;
import static org.hyperledger.besu.sila.transaction.TransactionInvalidReason.BLOB_GAS_PRICE_BELOW_CURRENT_BLOB_BASE_FEE;
...
import static org.hyperledger.besu.sila.transaction.TransactionInvalidReason.MAX_PRIORITY_FEE_PER_GAS_EXCEEDS_MAX_FEE_PER_GAS;
...
public class SilaMainnetTransactionValidatorTest extends TrustedSetupClassLoaderExtension {
  ...
  protected TransactionValidator createTransactionValidator(
    ...
    return new SilaMainnetTransactionValidator(
        gasCalculator,
        gasLimitCalculator,
        feeMarket,
  ...
  @Test
  public void shouldRejectTransactionIfFloorExceedsGasLimit_SIP_7623() {
    final TransactionValidator validator =
        createTransactionValidator(
            gasCalculator, GasLimitCalculator.constant(), false, Optional.empty());
    final Transaction transaction =
  ...
  @Test
  public void shouldRejectAccessListTransactionIfFloorExceedsGasLimit_SIP_7981() {
    final TransactionValidator validator =
        createTransactionValidator(
            gasCalculator,
            ...
            Integer.MAX_VALUE);
    // Under SIP-7981, access list bytes contribute to the transaction floor cost; this test
  ...
  public void shouldRejectTransactionWithMaxPriorityFeeGreaterThanMaxFee() {
    final TransactionValidator validator =
        createTransactionValidator(
            ...
            Set.of(
                new TransactionType[] {
                  TransactionType.FRONTIER, TransactionType.ACCESS_LIST, TransactionType.SIP1559
                }),
            Integer.MAX_VALUE);
  ...
  public void shouldAcceptOnlyTransactionsInAcceptedTransactionTypes() {
    ...
    final TransactionValidator sip1559Validator =
        new SilaMainnetTransactionValidator(
            gasCalculator,
            GasLimitCalculator.constant(),
            FeeMarket.london(0L),
            false,
            Optional.of(BigInteger.ONE),
            Set.of(TransactionType.FRONTIER, TransactionType.SIP1559),
            Set.of(BlobType.KZG_PROOF),
            Integer.MAX_VALUE);
    ...
    assertThat(
            sip1559Validator.validate(
                transaction, Optional.of(Wei.ONE), Optional.empty(), transactionProcessingParams))
        .isEqualTo(ValidationResult.valid());
  }

  @Test
  public void shouldRejectTransactionIfSIP1559TransactionGasPriceLessBaseFee() {
    final TransactionValidator validator =
        createTransactionValidator(
            gasCalculator,
            GasLimitCalculator.constant(),
  ...
  @Test
  public void shouldAcceptValidSIP1559() {
    final TransactionValidator validator =
        createTransactionValidator(
            gasCalculator,
            GasLimitCalculator.constant(),
  ...
  @Test
  public void shouldAcceptInitcodeAtSilaAmsterdamLimit() {
    final int maxInitcodeSize = SavmSpecVersion.AMSTERDAM.getMaxInitcodeSize();
    final TransactionValidator validator =
        createTransactionValidator(
            gasCalculator,
            GasLimitCalculator.constant(),
  ...
  @Test
  public void shouldRejectInitcodeAboveSilaAmsterdamLimit() {
    final int maxInitcodeSize = SavmSpecVersion.AMSTERDAM.getMaxInitcodeSize();
    final TransactionValidator validator =
        createTransactionValidator(
            gasCalculator,
  ...
  public void shouldRejectContractCreateWithBlob() {
    /*
    https://github.com/sila-chain/SIPs/blob/master/SIPS/sip-4844.md#blob-transaction
    ...
    final TransactionValidator validator =
        createTransactionValidator(
            ...
            false,
            Optional.of(BigInteger.ONE),
            Set.of(TransactionType.FRONTIER, TransactionType.SIP1559, TransactionType.BLOB),
            0xc000);
  ...
  @ParameterizedTest
  @MethodSource("shouldSupportTransactionGasLimitCap_SIP_7825")
  public void shouldSupportTransactionGasLimitCap_SIP_7825(
  ...
  private static Stream<Arguments> shouldSupportTransactionGasLimitCap_SIP_7825() {
    return Stream.of(
