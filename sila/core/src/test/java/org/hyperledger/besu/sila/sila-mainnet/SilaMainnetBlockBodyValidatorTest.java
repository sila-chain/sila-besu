...
import static org.hyperledger.besu.sila.sila-mainnet.HeaderValidationMode.NONE;
...
import org.hyperledger.besu.sila.sila-mainnet.requests.RequestsValidator;
...
class SilaMainnetBlockBodyValidatorTest {
  private final BlockDataGenerator blockDataGenerator = new BlockDataGenerator();
  private final BlockchainSetupUtil blockchainSetupUtil = BlockchainSetupUtil.forSilaMainnet();
  ...
  void validatesWithdrawals() {
    ...
    assertThat(
            new SilaMainnetBlockBodyValidator(protocolSchedule)
                .validateBodyLight(
  ...
  public void noneValidationModeDoesNothing() {
    ...
    final SilaMainnetBlockBodyValidator bodyValidator = new SilaMainnetBlockBodyValidator(protocolSchedule);
  ...
  public void lightValidationDoesNotCheckRoots() {
    ...
    final SilaMainnetBlockBodyValidator bodyValidator = new SilaMainnetBlockBodyValidator(protocolSchedule);
    final SilaMainnetBlockBodyValidator bodyValidatorSpy = spy(bodyValidator);
