 ...
 */
package org.hyperledger.besu.sila.trie.forest.worldview;

import static org.assertj.core.api.Assertions.assertThat;
import static org.hyperledger.besu.sila.core.InMemoryKeyValueStorageProvider.createInMemoryWorldState;
...
import org.hyperledger.besu.savm.worldstate.WorldState.StreamableAccount;
...
class ForestMutableWorldStateTest {
  ...
  private static MutableWorldState createEmpty(final ForestWorldStateKeyValueStorage storage) {
    ...
    return new ForestMutableWorldState(storage, preimageStorage, SavmConfiguration.DEFAULT);
  }
