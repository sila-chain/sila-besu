...
public class CoinbaseFeePriceCalculatorTest {
  ...
  private static final CoinbaseFeePriceCalculator SIP_1559_CALCULATOR =
      CoinbaseFeePriceCalculator.sip1559();
  ...
  public static Stream<Arguments> data() {
    return Stream.of(
        ...
        // SIP-1559 must return gas * (gas price - base fee)
        Arguments.of(SIP_1559_CALCULATOR, 100L, Wei.of(10L), Optional.of(Wei.of(4L)), Wei.of(600L))
        // Negative transaction gas price case
        // {SIP_1559_CALCULATOR, Gas.of(100), Wei.of(95L), Optional.of(100L), Wei.of(-500L)}
        );
  }
