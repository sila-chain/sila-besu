...
public class TransactionReceiptDecoderStrategyTest {
  ...
  @Test
  void decodesSip1559Receipt() {
    final TransactionReceipt original =
        new TransactionReceipt(TransactionType.SIP1559, 1, 100_000L, List.of(), Optional.empty());
    ...
    assertThat(decoded.getStatus()).isEqualTo(1);
    assertThat(decoded.getTransactionType()).isEqualTo(TransactionType.SIP1559);
  }
