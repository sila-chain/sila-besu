...
class SilaAmsterdamTargetingGasLimitCalculatorTest {
   ...
   * base_fee_per_gas=7 and SilaAmsterdam's baseFeeUpdateFraction=11684671, the blob gas price is 1
   * at low excess values, so base_blob_tx_price (7*8192=57344) < target_blob_gas_price
