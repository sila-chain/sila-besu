...
/** Tests for {@link SilaMainnetBlockAccessListValidator}. */
class SilaMainnetBlockAccessListValidatorTest {
  ...
  private static BlockAccessListValidator validatorWithItemCost(final long itemCost) {
    ...
    final org.hyperledger.besu.savm.gascalculator.GasCalculator gasCalculator =
        mock(org.hyperledger.besu.savm.gascalculator.GasCalculator.class);
    ...
    void atExactSizeLimit() {
      ...
      final BlockAccessList.AccountChanges account2 =
          new BlockAccessList.AccountChanges(
              ADDR_2, List.of(), List.of(), List.of(), List.of(), List.of());
      final BlockAccessList bal = new BlockAccessList(List.of(account1, account2));
      // 2 addresses + 1 storage key = 3 items, max = 3 with gas 6000 (SilaPrague ITEM_COST=2000)
