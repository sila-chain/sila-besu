...
public class SilaMainnetProtocolSpecsTest {
  ...
  private final SavmConfiguration savmConfiguration = SavmConfiguration.DEFAULT;
  ...
  public void setUp() {
    ...
    when(blobScheduleOptions.getSilaPrague()).thenReturn(Optional.of(pragueBlobSchedule));
  ...
  public void pragueDefinitionShouldThrowExceptionWhenAllContractAddressesAreMissing() {
    ...
    assertThatExceptionOfType(NoSuchElementException.class)
        .isThrownBy(
            () ->
                SilaMainnetProtocolSpecs.pragueDefinition(
                    chainId,
                    enableRevertReason,
  ...
  public void genesisCliqueBlockPeriodIsReturnedAsSlotTime() {
    ...
    final var protocolSpec =
        SilaMainnetProtocolSpecs.frontierDefinition(
                genesisConfigOptions,
                savmConfiguration,
                isParallelTxProcessingEnabled,
                balConfiguration,
  ...
  @Test
  public void posSlotTimeIsReturnedFromSilaParisOnward() {
    final var miningConfiguration = MiningConfiguration.newDefault();
    final var protocolSpec =
        SilaMainnetProtocolSpecs.parisDefinition(
  ...
  public void changeDefaultPosSlotTimeByConfiguration() {
    final var miningConfiguration =
        ImmutableMiningConfiguration.builder()
            ...
            .build();
    final var protocolSpec =
        SilaMainnetProtocolSpecs.cancunDefinition(
                Optional.of(BigInteger.ONE),
                true,
                genesisConfigOptions,
                savmConfiguration,
