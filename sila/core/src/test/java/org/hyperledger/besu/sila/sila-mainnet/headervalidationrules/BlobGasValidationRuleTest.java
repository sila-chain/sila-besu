 ...
 */
package org.hyperledger.besu.sila.sila-mainnet.headervalidationrules;
...
public class BlobGasValidationRuleTest {
  ...
  /**
   * SilaCancun SIP-4844 - Tests that the header blob gas is different from the calculated blob gas and
   * fails validation.
   */
  @Test
   ...
   */
  @Test
  public void validateHeader_BlobGasMatchesCalculated_SuccessValidation_SilaPrague() {
  ...
  /**
   * SilaPrague SIP-7840 - Tests that the header blob gas is different from the calculated blob gas and
   * fails validation.
   */
  @Test
  public void validateHeader_BlobGasDifferentFromCalculated_FailsValidation_SilaPrague() {
    long target = pragueGasLimitCalculator.getTargetBlobGasPerBlock();
