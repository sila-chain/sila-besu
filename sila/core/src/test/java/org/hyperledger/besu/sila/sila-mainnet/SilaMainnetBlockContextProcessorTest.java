...
public class SilaMainnetBlockContextProcessorTest {
  ...
  private SilaMainnetTransactionProcessor mockTransactionProcessor;
  ...
  public void setUp() {
    ...
    mockTransactionProcessor = mock(SilaMainnetTransactionProcessor.class);
