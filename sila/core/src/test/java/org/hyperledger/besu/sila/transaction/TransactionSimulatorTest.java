...
import static org.hyperledger.besu.savm.tracing.OperationTracer.NO_TRACING;
...
import org.hyperledger.besu.sila.core.CodeDelegation;
...
import org.hyperledger.besu.sila.processing.TransactionProcessingResult.Status;
...
public class TransactionSimulatorTest extends TrustedSetupClassLoaderExtension {
  ...
  public void simulateOnPendingBlockWorks() {
    final CallParameter callParameter = sip1559TransactionCallParameterBuilder().build();
  ...
  public void shouldSetFeePerGasToZeroWhenExceedingBalanceAllowed() {
    final CallParameter callParameter =
        sip1559TransactionCallParameterBuilder()
  ...
  public void shouldUseSpecifiedNonceWhenProvided() {
    ...
    final CallParameter callParameter =
        sip1559TransactionCallParameterBuilder().nonce(expectedNonce).build();
  ...
  @Test
  public void shouldReturnSuccessfulResultWhenSip1559TransactionProcessingIsSuccessful() {
    final CallParameter callParameter = sip1559TransactionCallParameterBuilder().build();
  ...
  public void shouldCapGasLimitWhenOriginalTransactionExceedsGasCap() {
    final CallParameter callParameter =
        sip1559TransactionCallParameterBuilder().gas(RPC_GAS_CAP + 1).build();
  ...
  public void shouldUseProvidedGasLimitWhenBelowRpcCapGas() {
    final CallParameter callParameter =
        sip1559TransactionCallParameterBuilder().gas(RPC_GAS_CAP / 2).build();
  ...
  public void shouldUseRpcGasCapWhenGasLimitNotPresent() {
    ...
    final CallParameter callParameter =
        sip1559TransactionCallParameterBuilder().gas(OptionalLong.empty()).build();
  ...
  private ImmutableCallParameter.Builder sip1559TransactionCallParameterBuilder() {
  ...
  private CallParameter blobTransactionCallParameter() {
    ...
    return sip1559TransactionCallParameterBuilder()
        .nonce(1)
        .chainId(BigInteger.ONE)
        .maxFeePerGas(Wei.ZERO)
        .maxPriorityFeePerGas(Wei.ZERO)
