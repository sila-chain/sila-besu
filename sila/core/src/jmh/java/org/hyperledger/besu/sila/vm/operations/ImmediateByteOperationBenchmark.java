...
/**
 * Base benchmark class for SAVM operations that use immediate byte operands.
 *
 * <p>This class provides common setup for operations like DUPN, SWAPN, and EXCHANGE (SIP-8024)
