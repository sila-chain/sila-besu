...
public class SyncTargetRange {
  ...
  private final SilPeer syncTarget;
  private final BlockHeader start;
  private final Optional<BlockHeader> end;

  public SyncTargetRange(final SilPeer syncTarget, final BlockHeader start) {
    this.syncTarget = syncTarget;
    this.start = start;
    this.end = Optional.empty();
  }

  public SyncTargetRange(final SilPeer syncTarget, final BlockHeader start, final BlockHeader end) {
    this.syncTarget = syncTarget;
    this.start = start;
    this.end = Optional.of(end);
  }

  public SilPeer getSyncTarget() {
    return syncTarget;
  }
