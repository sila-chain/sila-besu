...
class NewPooledTransactionHashesMessageSender {
  ...
  public void sendTransactionAnnouncementsToPeer(final SilPeer peer) {
    final Capability capability = peer.getConnection().capability(SilProtocol.NAME);
  ...
  private boolean send(
      final SilPeer peer, final List<Transaction> txBatch, final Capability capability) {
