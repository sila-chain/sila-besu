...
public class GetSyncReceiptsFromPeerTask implements PeerTask<GetSyncReceiptsFromPeerTask.Response> {
  ...
  public Predicate<SilPeerImmutableAttributes> getPeerRequirementFilter() {
    return (silPeer) -> isPoS || silPeer.estimatedChainHeight() >= requiredBlockchainHeight;
  }
  ...
  private long calculateTxGasLimitUpperBound(final SyncBlock lastBlockReceived) {
    ...
    // for everything before SilaOsaka we use the block gas limit of 45M and for SilaOsaka onward
