...
import static org.hyperledger.besu.sila.sil.transactions.TransactionAddedResult.REJECTED_UNDERPRICED_REPLACEMENT;
import static org.hyperledger.besu.sila.sil.transactions.TransactionAddedResult.TRY_NEXT_LAYER;
import static org.hyperledger.besu.sila.sil.transactions.TransactionPoolStructuredLogUtils.logAdded;
import static org.hyperledger.besu.sila.sil.transactions.TransactionPoolStructuredLogUtils.logMoved;
import static org.hyperledger.besu.sila.sil.transactions.TransactionPoolStructuredLogUtils.logPenalized;
import static org.hyperledger.besu.sila.sil.transactions.TransactionPoolStructuredLogUtils.logRemoved;
import static org.hyperledger.besu.sila.sil.transactions.layered.AddReason.MOVE;
import static org.hyperledger.besu.sila.sil.transactions.layered.LayeredRemovalReason.LayerMoveReason.EVICTED;
import static org.hyperledger.besu.sila.sil.transactions.layered.LayeredRemovalReason.PoolRemovalReason.BELOW_MIN_SCORE;
import static org.hyperledger.besu.sila.sil.transactions.layered.LayeredRemovalReason.PoolRemovalReason.CONFIRMED;
import static org.hyperledger.besu.sila.sil.transactions.layered.LayeredRemovalReason.PoolRemovalReason.CROSS_LAYER_REPLACED;
import static org.hyperledger.besu.sila.sil.transactions.layered.LayeredRemovalReason.PoolRemovalReason.REPLACED;
import static org.hyperledger.besu.sila.sil.transactions.layered.LayeredRemovalReason.RemovedFrom.POOL;
...
import org.hyperledger.besu.sila.sil.transactions.PendingTransactionDroppedListener;
  ...
  public TransactionAddedResult add(
    ...
    if (addStatus.isSuccess()) {
      ...
      if (addReason.sendNotification()) {
        ...
        silScheduler.scheduleServiceTask(() -> notifyTransactionAdded(addedPendingTransaction));
      }
