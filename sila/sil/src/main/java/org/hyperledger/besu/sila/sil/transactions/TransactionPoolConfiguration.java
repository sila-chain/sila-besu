...
public interface TransactionPoolConfiguration {
  ...
  @Value.Immutable
  interface Unstable {
    Duration SIL65_TRX_ANNOUNCED_BUFFERING_PERIOD = Duration.ofMillis(500);
    ...
    @Value.Default
    default Duration getSil65TrxAnnouncedBufferingPeriod() {
      return SIL65_TRX_ANNOUNCED_BUFFERING_PERIOD;
    }
