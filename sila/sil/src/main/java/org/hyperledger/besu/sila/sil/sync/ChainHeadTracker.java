...
public class ChainHeadTracker {
  ...
  public ChainHeadTracker(final SilContext silContext, final ProtocolSchedule protocolSchedule) {
  ...
  public CompletableFuture<BlockHeader> getBestHeaderFromPeer(final SilPeer peer) {
    LOG.atDebug()
