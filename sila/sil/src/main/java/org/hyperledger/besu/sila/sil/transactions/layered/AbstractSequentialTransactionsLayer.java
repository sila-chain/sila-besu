...
import static org.hyperledger.besu.sila.sil.transactions.layered.LayeredRemovalReason.LayerMoveReason.FOLLOW_INVALIDATED;
...
public abstract class AbstractSequentialTransactionsLayer extends AbstractTransactionsLayer {
  ...
  public AbstractSequentialTransactionsLayer(
    ...
    super(poolConfig, silScheduler, nextLayer, transactionReplacementTester, metrics, blobCache);
  }
