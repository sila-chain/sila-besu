...
public class BaseFeePrioritizedTransactionsTest extends AbstractPrioritizedTransactionsTestBase {
  private static final FeeMarket SIP1559_FEE_MARKET = FeeMarket.london(0L);
  ...
  protected Transaction createTransaction(
    ...
    return createTransaction(
        randomizeTxType.nextBoolean() ? SIP1559 : FRONTIER, nonce, maxGasPrice, keys);
  }
