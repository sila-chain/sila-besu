...
import static org.hyperledger.besu.sila.sil.manager.snap.SnapServer.HASH_LAST;
...
public class SnapServerTest {
  ...
  public void setup(final FlatDbMode dbMode) {
    ...
    snapServer = new SnapServer(new SilMessages(), storageCoordinator, spyProvider, Long.MAX_VALUE);
    snapServer.start();
