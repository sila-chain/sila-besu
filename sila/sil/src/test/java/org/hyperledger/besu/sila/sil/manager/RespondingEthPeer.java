...
public class RespondingEthPeer {
  ...
  private static RespondingEthPeer create(
    ...
    final SilPeers silPeers = silProtocolManager.silContext().getEthPeers();
    ...
    } else if (SilProtocol.isEth69Compatible(capability)) {
    ...
    if (addToEthPeers) {
      ...
      // Don't call addPeerToEthPeers directly — let silPeerStatusExchanged handle it
