...
import static org.hyperledger.besu.sila.sil.transactions.layered.LayersTest.InputDelegation.NO_INPUT_DELEGATIONS;
import static org.hyperledger.besu.sila.sil.transactions.layered.LayersTest.InputDelegation.delegations;
import static org.hyperledger.besu.sila.sil.transactions.layered.LayersTest.InputDelegation.invalid;
import static org.hyperledger.besu.sila.sil.transactions.layered.LayersTest.InputDelegation.toCodeDelegations;
import static org.hyperledger.besu.sila.sil.transactions.layered.LayersTest.InputDelegation.valid;
...
public class LayersTest extends BaseTransactionPoolTest {
  ...
  static class Scenario extends BaseTransactionPoolTest implements Runnable {
    ...
    Scenario(final String description, final TransactionPoolConfiguration poolConfig) {
      ...
      this.pending =
          new LayeredPendingTransactions(protocolContext, poolConfig, this.prio, silScheduler);
    ...
    public Scenario addForSender(final Sender sender, final long... nonce) {
      return addForSender(sender, SIP1559, NO_INPUT_DELEGATIONS, nonce);
    }
    ...
    public Scenario addForSenders(final Object... args) {
      for (int i = 0; i < args.length; i = i + 2) {
        ...
        internalAddForSender(sender, SIP1559, NO_INPUT_DELEGATIONS, nonce);
      }
      actions.add(notificationsChecker::assertExpectedNotifications);
      return this;
    }
    ...
    private LiveTransactionMetadata create(
      ...
      final var newPendingTx =
          switch (type) {
            ...
            case SIP1559 -> createEIP1559PendingTransaction(sender, nonce);
                    ...
                    n -> {
                      ...
                      final var txMetadata =
                          maybeLiveTxMetadata.orElseGet(
                              () -> create(sender, SIP1559, NO_INPUT_DELEGATIONS, n));
