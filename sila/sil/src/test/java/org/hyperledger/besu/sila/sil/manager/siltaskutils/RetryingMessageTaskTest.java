...
public abstract class RetryingMessageTaskTest<T> extends AbstractMessageTaskTest<T, T> {
  ...
  public void failsWhenPeerReturnsPartialResultThenStops() {
    ...
    final RespondingSilPeer.Responder partialResponder =
        RespondingSilPeer.partialResponder(
            ...
            protocolSchedule,
            0.5f);
    final RespondingSilPeer.Responder emptyResponder = RespondingSilPeer.emptyResponder();
  ...
  public void completesWhenPeerReturnsPartialResult()
    ...
    assertResultMatchesExpectation(requestedData, future.get(), respondingPeer.getSilPeer());
  }
