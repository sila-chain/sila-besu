 ...
 */
package org.hyperledger.besu.sila.sil.transactions.pluginadapter;
...
class TransactionPoolServiceImplTest {
  ...
  void transactionAddedIsDeliveredAndClosedOnce() {
    ...
    final org.hyperledger.besu.sila.core.Transaction tx =
        mock(org.hyperledger.besu.sila.core.Transaction.class);
