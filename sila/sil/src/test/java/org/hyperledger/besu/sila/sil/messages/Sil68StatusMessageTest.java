...
public class Sil68StatusMessageTest {

  private final int version = SilProtocol.SIL68.getVersion();
  ...
  public void shouldHaveBlockRangeWhenSil69() {
    Exception exception =
        assertThrows(
            IllegalArgumentException.class,
            () -> builder.protocolVersion(SilProtocolVersion.V69).blockRange(null).build());
    assertThat(exception.getMessage())
  ...
  public void shouldHaveTotalDifficultWhenSil68() {
    Exception exception =
        assertThrows(
            IllegalArgumentException.class,
            () -> builder.protocolVersion(SilProtocolVersion.V68).totalDifficulty(null).build());
    assertThat(exception.getMessage())
  ...
  public void shouldNotHaveTotalDifficultWhenSil69() {
    Exception exception =
        assertThrows(
            ...
            () ->
                builder
                    .protocolVersion(SilProtocolVersion.V69)
