...
public class NewBlockMessageTest {
  ...
  public void roundTripNewBlockMessage() {
    ...
    assertThat(msg.getCode()).isEqualTo(SilProtocolMessages.NEW_BLOCK);
  ...
  public void rawMessageUpCastsToANewBlockMessage() {
    ...
    final RawMessage rawMsg = new RawMessage(SilProtocolMessages.NEW_BLOCK, tmp.encoded());

    final NewBlockMessage newBlockMsg = NewBlockMessage.readFrom(rawMsg);

    assertThat(newBlockMsg.getCode()).isEqualTo(SilProtocolMessages.NEW_BLOCK);
