...
import static org.hyperledger.besu.sila.transaction.TransactionInvalidReason.REPLAY_PROTECTED_SIGNATURE_REQUIRED;
import static org.hyperledger.besu.sila.transaction.TransactionInvalidReason.TRANSACTION_ALREADY_KNOWN;
import static org.hyperledger.besu.sila.transaction.TransactionInvalidReason.TRANSACTION_REPLACEMENT_UNDERPRICED;
import static org.hyperledger.besu.sila.transaction.TransactionInvalidReason.TX_FEECAP_EXCEEDED;
...
public abstract class AbstractTransactionPoolTest extends AbstractTransactionPoolTestBase {
  ...
  @Test
  public void shouldSendPooledTransactionHashesIfPeerSupportsSil65() {
    SilPeer peer = mock(SilPeer.class);
    when(peer.hasSupportForMessage(SilProtocolMessages.NEW_POOLED_TRANSACTION_HASHES))
        .thenReturn(true);
