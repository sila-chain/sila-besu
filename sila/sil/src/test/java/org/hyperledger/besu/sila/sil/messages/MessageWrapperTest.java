...
import static org.hyperledger.besu.sila.core.Transaction.REPLAY_UNPROTECTED_V_BASE_PLUS_1;
...
public class MessageWrapperTest {
  ...
  public void readFromExpectsListWrappingBodyFields() {
    ...
    final BlockBody blockBodyDecodefromRLP =
        BlockBody.readWrappedBodyFrom(bytesValueRLPInput, new SilaMainnetBlockHeaderFunctions());
  ...
  public void readBodyFieldsExpectsNoListWrappingBodyFields() {
    ...
    final BlockBody blockBodyDecodefromRLP =
        BlockBody.readFrom(bytesValueRLPInput, new SilaMainnetBlockHeaderFunctions());
