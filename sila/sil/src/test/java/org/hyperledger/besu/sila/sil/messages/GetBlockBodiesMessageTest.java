...
public final class GetBlockBodiesMessageTest {
  ...
  public void getBlockBodiesRoundTrip() throws IOException {
    ...
    for (int i = 0; i < 50; ++i) {
      ...
      oneBlock.enterList();
      hashes.add(BlockHeader.readFrom(oneBlock, new SilaMainnetBlockHeaderFunctions()).getHash());
    ...
    final MessageData raw =
        new RawMessage(SilProtocolMessages.GET_BLOCK_BODIES, initialMessage.getData());
