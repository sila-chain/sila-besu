...
SAVM Tool is a stand alone SAVM executor and test execution tool. The
principal purpose of the tool is for testing and validation of the SAVM
and enclosing data structures.

Using SAVM Tool in execution-specification-tests
-----------------------------------------------
...
```zsh
brew install sila solidity
git clone https://github.com/sila-chain/execution-spec-tests
...
sdk install java 25.0.3-tem 
sdk use java 25.0.3-tem
git clone https://github.com/sila-chain/sila-besu
cd besu
./gradlew installDist -x test
cd ..
