...
import static org.hyperledger.besu.savmtool.BenchmarkSubCommand.COMMAND_NAME;
...
import org.hyperledger.besu.savmtool.benchmarks.AltBN128Benchmark;
import org.hyperledger.besu.savmtool.benchmarks.BLS12Benchmark;
import org.hyperledger.besu.savmtool.benchmarks.BenchmarkConfig;
import org.hyperledger.besu.savmtool.benchmarks.BenchmarkExecutor;
import org.hyperledger.besu.savmtool.benchmarks.ECRecoverBenchmark;
import org.hyperledger.besu.savmtool.benchmarks.KZGPointEvalBenchmark;
import org.hyperledger.besu.savmtool.benchmarks.ModExpBenchmark;
import org.hyperledger.besu.savmtool.benchmarks.P256VerifyBenchmark;
import org.hyperledger.besu.savmtool.benchmarks.RipeMD160Benchmark;
import org.hyperledger.besu.savmtool.benchmarks.SHA256Benchmark;
...
/**
 * This class represents the BenchmarkSubCommand. It is responsible for executing an Sila State
 * Test.
 */
@CommandLine.Command(
    name = COMMAND_NAME,
...
public class BenchmarkSubCommand implements Runnable {
  ...
  @ParentCommand SavmToolCommand parentCommand;
