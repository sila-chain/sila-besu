...
import org.hyperledger.besu.sila.core.json.BesuJsonModule;
 ...
 * with standard configurations needed for savmtool. The ObjectMapper is configured to match the
...
public class JsonUtils {
  ...
  /**
   * Create an object mapper with all the standard bells and whistles needed for savmtool
   *
