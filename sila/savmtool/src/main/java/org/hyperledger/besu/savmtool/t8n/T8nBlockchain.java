 ...
 */
package org.hyperledger.besu.savmtool.t8n;
...
import org.hyperledger.besu.sila.chain.ChainReorgObserver;
...
/**
 * A blockchain mock for the Sila reference tests.
 *
 ...
 *
 * <p>The Sila reference tests for VM execution (VMTests) and transaction processing
...
public class T8nBlockchain implements Blockchain {
  ...
  private static final String NUMBER_LOOKUP_ERROR =
      "Blocks must not be looked up by number in the SAVM. The block being processed may not be on the canonical chain.";
