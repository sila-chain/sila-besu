...
import org.hyperledger.besu.sila.api.jsonrpc.internal.results.TransactionBaseResult;
import org.hyperledger.besu.sila.api.jsonrpc.internal.results.TransactionPendingResult;
...
class SilGetTransactionByHashTest {
  ...
  private SilGetTransactionByHash method;
  private final String JSON_RPC_VERSION = "2.0";
  private final String SIL_METHOD = "sil_getTransactionByHash";

  @Mock private TransactionPool transactionPool;

  @BeforeEach
  public void setUp() {
    method = new SilGetTransactionByHash(blockchainQueries, transactionPool);
  }
  ...
  void validateResultSpec() {
    ...
    final JsonRpcRequestContext request =
        new JsonRpcRequestContext(
            new JsonRpcRequest(JSON_RPC_VERSION, SIL_METHOD, new Object[] {hash}));
