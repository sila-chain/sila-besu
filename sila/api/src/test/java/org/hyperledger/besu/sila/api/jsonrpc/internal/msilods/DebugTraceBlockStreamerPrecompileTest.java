...
public class DebugTraceBlockStreamerPrecompileTest {
  ...
  // IDENTITY precompile — returns its input unchanged; no SAVM opcodes are executed
  ...
  /**
   * When the transaction target is a precompile, no SAVM opcodes run and tracePrecompileCall is the
