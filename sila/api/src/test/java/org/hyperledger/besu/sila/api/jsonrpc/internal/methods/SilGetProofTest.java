...
import org.hyperledger.besu.sila.api.jsonrpc.internal.results.proof.GetProofResult;
...
class SilGetProofTest {

  private static BlockchainQueries blockchainQueries;

  private SilGetProof method;
  private final String JSON_RPC_VERSION = "2.0";
  private final String SIL_METHOD = "sil_getProof";
  ...
  @BeforeEach
  void setUp() {
    method = new SilGetProof(blockchainQueries);
  }
  ...
  void nonExistentAccountStorageProofHasOneEntryPerRequestedKey() {
    ...
    assertThat(result.getStorageProof())
        .as("storageProof must contain one entry per requested key (SIP-1186)")
        .hasSize(3);
