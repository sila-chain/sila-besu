...
public class WebSocketConfigurationTest {
  ...
  public void settingNoAuthRpcApisShouldOverridePreviousValues() {
    ...
    configuration.setRpcApisNoAuth(Lists.newArrayList(RpcMethod.SIL_CALL.name()));
    assertThat(configuration.getRpcApisNoAuth()).containsExactly(RpcMethod.SIL_CALL.name());
  }
}
