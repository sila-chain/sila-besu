...
public class EngineNewPayloadV3Test extends EngineNewPayloadV2Test {
  ...
  @Override
  public void shouldReturnUnsupportedForkIfBlockTimestampIsAfterSilaCancunMilestone() {
  ...
  @Test
  public void shouldReturnUnsupportedForkIfBlockTimestampIsBeforeSilaCancunMilestone() {
  ...
  @Test
  public void shouldReturnInvalidParamsIfBlobGasUsedIsNullBeforeSilaCancun() {
    final BlockHeader preSilaCancunHeader =
        createBlockHeaderFixture(Optional.of(emptyList()))
            .timestamp(cancunHardfork.milestone() - 1)
            .excessBlobGas(BlobGas.ZERO)
            .blobGasUsed(null)
    ...
    var resp = resp(mockEnginePayload(preSilaCancunHeader, emptyList(), null));
    final JsonRpcError jsonRpcError = fromErrorResp(resp);
  ...
  @Test
  public void shouldReturnInvalidParamsIfExcessBlobGasIsNullBeforeSilaCancun() {
    final BlockHeader preSilaCancunHeader =
        createBlockHeaderFixture(Optional.of(emptyList()))
            .timestamp(cancunHardfork.milestone() - 1)
            .excessBlobGas(null)
