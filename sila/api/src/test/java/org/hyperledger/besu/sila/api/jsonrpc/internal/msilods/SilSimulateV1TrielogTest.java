...
import static org.hyperledger.besu.sila.core.InMemoryKeyValueStorageProvider.createBonsaiInMemoryWorldStateArchive;
...
import org.hyperledger.besu.sila.api.jsonrpc.internal.results.BlockStateCallResult;
...
public class SilSimulateV1TrielogTest {
  ...
  public void shouldReturnTrielogWhenReturnTrieLogTrue() {
    ...
    JsonRpcRequestContext request =
        new JsonRpcRequestContext(
            new JsonRpcRequest(
                "2.0", "sil_simulateV1", new Object[] {simulateV1Parameter, "latest"}));
  ...
  public void shouldNotReturnTrielogWhenReturnTrieLogFalse() {
    Address testAddress = Address.fromHexString("0xdeadbeef");
    CallParameter callParameter = simpleSend(testAddress, Wei.fromSil(1L));
