...
public class TransactionWithMetadataResultTest {
  ...
  @Test
  public void sip1559TransactionWithShortWeiVals() {
  ...
  @Test
  public void sip1559TransactionFields() {
    final BlockDataGenerator gen = new BlockDataGenerator();
    final Transaction transaction = gen.transaction(TransactionType.SIP1559);
