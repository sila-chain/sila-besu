...
public class SilBlockNumberTest {

  private final String JSON_RPC_VERSION = "2.0";
  private final String SIL_METHOD = "sil_blockNumber";

  @Mock private BlockchainQueries blockchainQueries;
  private SilBlockNumber method;

  @BeforeEach
  public void setUp() {
    method = new SilBlockNumber(blockchainQueries);
  }
  ...
  public void shouldReturnCorrectResult() {
    ...
    final JsonRpcRequestContext request =
        new JsonRpcRequestContext(
            new JsonRpcRequest(JSON_RPC_VERSION, SIL_METHOD, new Object[] {}));
