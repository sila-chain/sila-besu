...
public class SilNewBlockFilterTest {

  @Mock private FilterManager filterManager;
  private SilNewBlockFilter method;
  private final String SIL_METHOD = "sil_newBlockFilter";

  @BeforeEach
  public void setUp() {
    method = new SilNewBlockFilter(filterManager);
  }
  ...
  public void getResponse() {
    ...
    final JsonRpcRequestContext request =
        new JsonRpcRequestContext(new JsonRpcRequest("2.0", SIL_METHOD, new String[] {}));
