...
public class SilMaxPriorityFeePerGasTest {
  ...
  private SilMaxPriorityFeePerGas createEthMaxPriorityFeePerGasMethod() {
    return createEthMaxPriorityFeePerGasMethod(100L);
  }

  private SilMaxPriorityFeePerGas createEthMaxPriorityFeePerGasMethod(final long gasPriceBlocks) {
