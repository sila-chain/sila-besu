...
public class EngineGetPayloadV5Test extends AbstractEngineGetPayloadTest {
  ...
  @Test
  public void shouldReturnUnsupportedForkIfBlockTimestampIsBeforeSilaOsakaMilestone() {
  ...
  @Test
  public void shouldReturnUnsupportedForkIfBlockTimestampIsAtSilaAmsterdamMilestone() {
  ...
  @Test
  public void shouldReturnUnsupportedForkIfBlockTimestampIsAfterSilaAmsterdamMilestone() {
  ...
  protected long getValidPayloadTimestamp() {
    // V5 works with SilaOsaka (>= 60) but must be before SilaAmsterdam (< 70)
    return 65L;
  }
}
