...
import org.hyperledger.besu.sila.api.jsonrpc.health.HealthService.HealthCheck;
import org.hyperledger.besu.sila.api.jsonrpc.health.HealthService.ParamSource;
...
import org.hyperledger.besu.sila.api.jsonrpc.internal.response.MutableJsonRpcSuccessResponse;
...
public class JsonRpcJWTTest {
  ...
  private SilScheduler scheduler;
  ...
  public void initServerAndClient() {
    ...
    scheduler = new SilScheduler(1, 1, 1, new NoOpMetricsSystem());
  }
