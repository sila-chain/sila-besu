...
public class SilGetFilterLogsTest {

  private SilGetFilterLogs method;

  @Mock FilterManager filterManager;

  @BeforeEach
  public void setUp() {
    method = new SilGetFilterLogs(filterManager);
  }

  @Test
  public void shouldReturnCorrectMethodName() {
    assertThat(method.getName()).isEqualTo("sil_getFilterLogs");
  }

  @Test
  public void shouldReturnErrorWhenMissingParams() {
    final JsonRpcRequestContext request =
        new JsonRpcRequestContext(new JsonRpcRequest("2.0", "sil_getFilterLogs", new Object[] {}));
  ...
  private JsonRpcRequestContext requestWithFilterId(final Object... filterId) {
    return new JsonRpcRequestContext(new JsonRpcRequest("2.0", "sil_getFilterLogs", filterId));
  }
