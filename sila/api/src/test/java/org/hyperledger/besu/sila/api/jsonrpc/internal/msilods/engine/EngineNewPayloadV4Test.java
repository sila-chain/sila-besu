...
import static org.hyperledger.besu.sila.api.graphql.internal.response.GraphQLError.INVALID_PARAMS;
...
import org.hyperledger.besu.sila.api.jsonrpc.internal.results.EnginePayloadStatusResult;
...
import org.hyperledger.besu.sila.sila-mainnet.requests.ProhibitedRequestValidator;
...
public class EngineNewPayloadV4Test extends EngineNewPayloadV3Test {
  ...
  @Override
  public void shouldReturnUnsupportedForkIfBlockTimestampIsAfterSilaPragueMilestone() {
    // Only relevant for V3
  }

  @Test
  public void shouldReturnUnsupportedForkIfBlockTimestampIsBeforeSilaPragueMilestone() {
  ...
  @Test
  public void shouldReturnUnsupportedForkIfBlockTimestampIsAtOrAfterSilaAmsterdamMilestone() {
    when(protocolSchedule.milestoneFor(AMSTERDAM))
        .thenReturn(Optional.of(pragueHardfork.milestone() + 10L));

    final BlockHeader futureSipsHeader =
    ...
    final JsonRpcResponse resp = resp(mockEnginePayload(futureSipsHeader, emptyList()));
