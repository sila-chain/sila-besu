...
public class SilGetTransactionByBlockHashAndIndexTest {
  private SilGetTransactionByBlockHashAndIndex method;
  @Mock private BlockchainQueries blockchain;

  @Test
  public void shouldReturnNullWhenBlockHashDoesNotExist() {
    method = new SilGetTransactionByBlockHashAndIndex(blockchain);
