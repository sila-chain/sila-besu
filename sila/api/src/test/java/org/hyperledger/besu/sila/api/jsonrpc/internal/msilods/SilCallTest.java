...
import static org.hyperledger.besu.sila.api.jsonrpc.internal.response.RpcErrorType.REVERT_ERROR;
...
public class SilCallTest {

  private SilCall method;
  ...
  public void setUp() {
    ...
    method = new SilCall(blockchainQueries, transactionSimulator, metricsSystem);
  ...
  public void shouldReturnCorrectMethodName() {
    assertThat(method.getName()).isEqualTo("sil_call");
  }

  @Test
  public void noStateOverrides() {
    final JsonRpcRequestContext request = silCallRequest(callParameter(), "latest");
  ...
  public void someStateOverrides() {
    ...
    final JsonRpcRequestContext request =
        silCallRequestWithStateOverrides(callParameter(), "latest", expectedOverrides);
  ...
  public void fullStateOverrides() {
    ...
    final JsonRpcRequestContext request =
        silCallRequestWithStateOverrides(callParameter(), "latest", suppliedOverrides);
  ...
  public void shouldUseCorrectBlockNumberWhenEarliest() {
    final JsonRpcRequestContext request = silCallRequest(callParameter(), "earliest");
  ...
  public void shouldUseCorrectBlockNumberWhenSafe() {
    final JsonRpcRequestContext request = silCallRequest(callParameter(), "safe");
  ...
  public void shouldUseCorrectBlockNumberWhenFinalized() {
    final JsonRpcRequestContext request = silCallRequest(callParameter(), "finalized");
    when(blockchainQueries.getBlockHeaderByHash(Hash.ZERO)).thenReturn(Optional.of(blockHeader));
  ...
  public void shouldUseCorrectBlockNumberWhenSpecified() {
    final JsonRpcRequestContext request = silCallRequest(callParameter(), Quantity.create(13L));
  ...
  public void shouldReturnNullWhenInvalidBlockNumberSpecified() {
    final JsonRpcRequestContext request = silCallRequest(callParameter(), Quantity.create(33L));
    when(blockchainQueries.headBlockNumber()).thenReturn(14L);
  ...
  @Test
  public void shouldAutoSelectIsAllowedExceedingBalanceToTrueWhenGasPriceIsZeroAfterSIP1559() {
    final CallParameter callParameters = callParameter();
  ...
  @Test
  public void shouldAutoSelectIsAllowedExceedingBalanceToFalseWhenGasPriceIsNotZeroAfterSIP1559() {
    final CallParameter callParameters =
        callParameter(
            Optional.of(Wei.ONE), Optional.empty(), Optional.empty(), OptionalLong.empty());
  ...
  public void shouldAllowTxGasLimitBiggerThanCap() {
    ...
    final JsonRpcRequestContext request = silCallRequest(callParameters, "latest");
    final JsonRpcResponse expectedResponse =
        new JsonRpcSuccessResponse(null, Bytes.of(1).toString());
    mockTransactionProcessorSuccessResult(expectedResponse);
    when(blockchainQueries.getBlockchain()).thenReturn(blockchain);
  ...
  private JsonRpcRequestContext silCallRequest(
      final CallParameter callParameter, final String blockNumberInHex) {
    return new JsonRpcRequestContext(
        new JsonRpcRequest("2.0", "sil_call", new Object[] {callParameter, blockNumberInHex}));
  }

  private JsonRpcRequestContext silCallRequestWithStateOverrides(
      final CallParameter callParameter,
      final String blockNumberInHex,
      final StateOverrideMap overrides) {
    return new JsonRpcRequestContext(
        new JsonRpcRequest(
            "2.0", "sil_call", new Object[] {callParameter, blockNumberInHex, overrides}));
  }
