...
public class JsonRpcConfigurationTest {
  ...
  public void settingRpcApisShouldOverridePreviousValues() {
    ...
    configuration.setRpcApis(Lists.newArrayList(RpcApis.SIL.name(), RpcApis.MINER.name()));
    assertThat(configuration.getRpcApis())
        .containsExactly(RpcApis.SIL.name(), RpcApis.MINER.name());
  ...
  public void settingNoAuthRpcApisShouldOverridePreviousValues() {
    ...
    configuration.setNoAuthRpcApis(Lists.newArrayList(RpcMethod.SIL_CALL.name()));
    assertThat(configuration.getNoAuthRpcApis()).containsExactly(RpcMethod.SIL_CALL.name());
  }
