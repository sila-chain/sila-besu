...
public class SilChainIdTest {

  private SilChainId method;
  private final BigInteger CHAIN_ID = BigInteger.ONE;

  @BeforeEach
  public void setUp() {
    method = new SilChainId(Optional.of(CHAIN_ID));
  }

  @Test
  public void shouldReturnCorrectMethodName() {
    assertThat(method.getName()).isEqualTo("sil_chainId");
  }
  ...
  public void shouldReturnNullWhenNoChainId() {
    method = new SilChainId(Optional.empty());
  ...
  private JsonRpcRequestContext request() {
    return new JsonRpcRequestContext(new JsonRpcRequest(null, "sil_chainId", null));
  }
}
