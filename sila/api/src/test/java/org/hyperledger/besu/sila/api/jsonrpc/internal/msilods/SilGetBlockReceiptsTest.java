...
import org.hyperledger.besu.sila.api.jsonrpc.internal.results.BlockReceiptsResult;
import org.hyperledger.besu.sila.api.jsonrpc.internal.results.TransactionReceiptResult;
...
public class SilGetBlockReceiptsTest {
  ...
  private static final String SIL_METHOD = "sil_getBlockReceipts";
  ...
  private SilGetBlockReceipts method;
  ...
  public void setUp() {
    ...
    method = new SilGetBlockReceipts(blockchainQueries, protocolSchedule);
  }
  ...
  public void twoReceiptsForLatestBlock() {
    ...
    assertThat(tx1.getType())
        .isEqualTo(String.format("0x%X", expectedTx1.getType().getSilSerializedType()));
    ...
    assertThat(tx2.getType())
        .isEqualTo(String.format("0x%X", expectedTx2.getType().getSilSerializedType()));
  }
