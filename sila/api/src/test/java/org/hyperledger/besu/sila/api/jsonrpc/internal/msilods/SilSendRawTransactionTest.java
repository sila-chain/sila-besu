...
public class SilSendRawTransactionTest {
  ...
  private SilSendRawTransaction method;

  @BeforeEach
  public void before() {
    method = new SilSendRawTransaction(transactionPool);
  }
  ...
  public void requestIsMissingParameter() {
    final JsonRpcRequestContext request =
        new JsonRpcRequestContext(
            new JsonRpcRequest("2.0", "sil_sendRawTransaction", new String[] {}));
  ...
  public void requestHasNullObjectParameter() {
    final JsonRpcRequestContext request =
        new JsonRpcRequestContext(new JsonRpcRequest("2.0", "sil_sendRawTransaction", null));
  ...
  public void requestHasNullArrayParameter() {
    final JsonRpcRequestContext request =
        new JsonRpcRequestContext(
            new JsonRpcRequest("2.0", "sil_sendRawTransaction", new String[] {null}));
  ...
  public void invalidTransactionRlpDecoding() {
    ...
    final JsonRpcRequestContext request =
        new JsonRpcRequestContext(
            new JsonRpcRequest("2.0", "sil_sendRawTransaction", new String[] {rawTransaction}));
  ...
  public void validTransactionIsSentToTransactionPool() {
    ...
    final JsonRpcRequestContext request =
        new JsonRpcRequestContext(
            new JsonRpcRequest("2.0", "sil_sendRawTransaction", new String[] {VALID_TRANSACTION}));
  ...
  public void getMethodReturnsExpectedName() {
    assertThat(method.getName()).matches("sil_sendRawTransaction");
  }
}
