...
import org.hyperledger.besu.sila.api.jsonrpc.internal.results.BlockAccessListResult;
...
public class SilGetBlockAccessListTest {
  private final BlockDataGenerator blockDataGenerator = new BlockDataGenerator();
  private SilGetBlockAccessList method;
  ...
  public void setUp() {
    ...
    method = new SilGetBlockAccessList(blockchainQueries);
  }

  @Test
  public void shouldReturnCorrectMethodName() {
    assertThat(method.getName()).isEqualTo("sil_getBlockAccessList");
  }
  ...
  @Test
  public void shouldReturnErrorForPreSilaAmsterdamBlocks() {
    final long blockNumber = 5L;
    final BlockHeader header = blockDataGenerator.header(blockNumber);
    final Hash blockHash = header.getHash();
