...
public class SilGetLogsTest {

  private SilGetLogs method;
  ...
  @BeforeEach
  public void setUp() {
    method = new SilGetLogs(blockchainQueries, maxLogRange);
  }

  @Test
  public void shouldReturnCorrectMethodName() {
    assertThat(method.getName()).isEqualTo("sil_getLogs");
  }

  @Test
  public void shouldReturnErrorWhenMissingParams() {
    final JsonRpcRequestContext request =
        new JsonRpcRequestContext(new JsonRpcRequest("2.0", "sil_getLogs", new Object[] {}));
  ...
  public void shouldFailIfBlockHashNotFound() {
    ...
    final JsonRpcRequestContext request =
        new JsonRpcRequestContext(
            new JsonRpcRequest("2.0", "sil_getLogs", new Object[] {filterParameter}));
