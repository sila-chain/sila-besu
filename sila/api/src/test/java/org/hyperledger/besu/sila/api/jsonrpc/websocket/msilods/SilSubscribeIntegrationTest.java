...
public class SilSubscribeIntegrationTest {
  ...
  public void before() {
    ...
    webSocketMessageHandler =
        new WebSocketMessageHandler(
            ...
            Mockito.mock(SilScheduler.class),
  ...
  public void shouldAddConnectionToMap() throws InterruptedException {
    ...
    final JsonRpcRequest subscribeRequestBody = createSilSubscribeRequestBody(CONNECTION_ID_1);
  ...
  public void shouldAddMultipleConnectionsToMap() throws InterruptedException {
    ...
    final JsonRpcRequest subscribeRequestBody1 = createSilSubscribeRequestBody(CONNECTION_ID_1);
    final JsonRpcRequest subscribeRequestBody2 = createSilSubscribeRequestBody(CONNECTION_ID_2);
  ...
  private WebSocketRpcRequest createSilSubscribeRequestBody(final String connectionId) {
    return Json.decodeValue(
        "{\"id\": 1, \"method\": \"sil_subscribe\", \"params\": [\"syncing\"], \"connectionId\": \""
            + connectionId
            + "\"}",
