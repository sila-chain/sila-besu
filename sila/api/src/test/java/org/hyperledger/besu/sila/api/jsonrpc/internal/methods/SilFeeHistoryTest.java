...
import org.hyperledger.besu.sila.api.jsonrpc.internal.results.ImmutableFeeHistoryResult;
...
public class SilFeeHistoryTest {
  final BlockDataGenerator gen = new BlockDataGenerator();
  private BlockchainQueries blockchainQueries;
  private MutableBlockchain blockchain;
  private SilFeeHistory method;
  ...
  public void shouldComputeRewardsCorrectly() {
    ...
    List<Wei> rewards = silFeeHistory.computeRewards(rewardPercentiles, block, Wei.of(7));
  ...
  public void shouldBoundRewardsCorrectly() {
    ...
    SilFeeHistory silFeeHistory =
        new SilFeeHistory(null, blockchainQueries, miningCoordinator, apiConfiguration);
  ...
  public void shouldApplyLowerBoundRewardsCorrectly() {
    ...
    List<Wei> rewards = silFeeHistory.computeRewards(rewardPercentiles, block, Wei.of(8));
  ...
  public void shouldNotUnderflowWhenNextBaseFeeExceedsGasPriceLowerBound() {
    ...
    List<Wei> rewards = silFeeHistory.computeRewards(rewardPercentiles, block, Wei.of(50));
  ...
  public void throwsWhenReceiptCountDiffersFromTransactionCount() {
    ...
    assertThatThrownBy(() -> silFeeHistory.computeRewards(List.of(50.0), block, Wei.of(7)))
  ...
  public void latestResultCacheMissesWhenNextBlockHardforkChanges() {
    ...
    when(cancunSpec.getGasCalculator()).thenReturn(new SilaCancunGasCalculator());
  ...
  private JsonRpcResponse feeHistoryRequest(final Object... params) {
    return method.response(
        new JsonRpcRequestContext(new JsonRpcRequest("2.0", "sil_feeHistory", params)));
  }
