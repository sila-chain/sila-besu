...
class JsonRpcExecutorHandlerTest {
  ...
  void testTimeoutHandlingForJsonObjectRequest() {
    ...
    final JsonObject jsonRequest =
        new JsonObject().put("jsonrpc", "2.0").put("id", 1).put("method", "sil_blockNumber");
   ...
   * org.hyperledger.besu.sila.api.jsonrpc.JsonResponseStreamer} needs, regardless of which executor
   * (object-streaming or array/batch) is driving it.
   */
