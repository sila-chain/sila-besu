 ...
 */
package org.hyperledger.besu.sila.api.jsonrpc.websocket.methods;
...
import org.hyperledger.besu.sila.api.jsonrpc.websocket.subscription.SubscriptionNotFoundException;
import org.hyperledger.besu.sila.api.jsonrpc.websocket.subscription.request.InvalidSubscriptionRequestException;
import org.hyperledger.besu.sila.api.jsonrpc.websocket.subscription.request.SubscriptionRequestMapper;
...
public class SilUnsubscribeTest {

  private SilUnsubscribe silUnsubscribe;
  ...
  public void before() {
    ...
    silUnsubscribe = new SilUnsubscribe(subscriptionManagerMock, mapperMock);
  }

  @Test
  public void nameIsSilUnsubscribe() {
    assertThat(silUnsubscribe.getName()).isEqualTo("sil_unsubscribe");
  }
  ...
  public void responseContainsUnsubscribeStatus() {
    ...
    assertThat(silUnsubscribe.response(request)).isEqualTo(expectedResponse);
  }
  ...
  private JsonRpcRequestContext createJsonRpcRequest() {
    return new JsonRpcRequestContext(
        Json.decodeValue(
            "{\"id\": 1, \"method\": \"sil_unsubscribe\", \"params\": [\"0x0\"]}",
