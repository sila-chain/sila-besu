...
public class DebugGsilTraceJsonRpcHttpBySpecTest extends AbstractJsonRpcHttpBySpecTest {
  @Override
  ...
  protected BlockchainSetupUtil getBlockchainSetupUtil(final DataStorageFormat storageFormat) {
    return createBlockchainSetupUtil(
        "debug-gsil/chain-data/genesis.json", "debug-gsil/chain-data/blocks.bin", storageFormat);
  }
  ...
  public static Object[][] specs() {
    return AbstractJsonRpcHttpBySpecTest.findSpecFiles(
        new String[] {
          "debug-gsil/specs/prestate-tracer/diff-mode-true",
          "debug-gsil/specs/prestate-tracer/diff-mode-false",
          "debug-gsil/specs/call-tracer",
          "debug-gsil/specs/4byte-tracer"
        });
  }
}
