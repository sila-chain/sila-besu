 ...
 */
package org.hyperledger.besu.sila.api.jsonrpc.ipc;
...
class JsonRpcIpcServiceTest {
  ...
  void subscriptionRequestSuccessful() {
    ...
    final String request = "{\"id\":1,\"method\":\"sil_subscribe\",\"params\":[\"newHeads\"]}\n";
  ...
  void unsubscribeRequestSuccessful() {
    ...
    final String unsubscribeRequest =
        "{\"id\":2,\"method\":\"sil_unsubscribe\",\"params\":[\"0x1\"]}\n";
  ...
  void batchRequestDoesNotSupportSubscriptions() {
    ...
    final String batchRequest =
        "[{\"id\":1,\"method\":\"sil_subscribe\",\"params\":[\"newHeads\"]},"
            + "{\"id\":2,\"method\":\"sil_subscribe\",\"params\":[\"logs\"]}]";
