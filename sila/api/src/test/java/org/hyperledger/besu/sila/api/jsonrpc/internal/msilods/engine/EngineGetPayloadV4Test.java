...
public class EngineGetPayloadV4Test extends AbstractEngineGetPayloadTest {
  ...
  @Test
  public void shouldReturnUnsupportedForkIfBlockTimestampIsAtSilaOsakaMilestone() {
  ...
  @Test
  public void shouldReturnUnsupportedForkIfBlockTimestampIsAfterSilaOsakaMilestone() {
  ...
  protected long getValidPayloadTimestamp() {
    // V4 works with SilaPrague (>= 50) but must be before SilaOsaka (< 60)
    return 55L;
  }
}
