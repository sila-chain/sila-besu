...
public class SilGasPriceTest {
  ...
  public void setUp() {
    ...
    method = createSilGasPriceMethod(apiConfig);
  }
  ...
  public void whenGasPriceBlocksIsZeroReturnLowerBoundWithoutSamplingHistoricalBlocks() {
    ...
    method =
        createSilGasPriceMethod(ImmutableApiConfiguration.builder().gasPriceBlocks(0L).build());
  ...
  private SilGasPrice createSilGasPriceMethod(final ApiConfiguration apiConfig) {
