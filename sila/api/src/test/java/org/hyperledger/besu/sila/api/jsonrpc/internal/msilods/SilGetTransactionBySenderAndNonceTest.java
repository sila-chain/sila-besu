...
class SilGetTransactionBySenderAndNonceTest {
  ...
  private static final String METHOD = "sil_getTransactionBySenderAndNonce";

  @Mock private BlockchainQueries blockchainQueries;
  @Mock private TransactionPool transactionPool;

  private SilGetTransactionBySenderAndNonce method;

  @BeforeEach
  void setUp() {
    method = new SilGetTransactionBySenderAndNonce(blockchainQueries, transactionPool);
  }
