...
public class SilGetFilterChangesTest {
  ...
  public void shouldReturnCorrectMethodName() {
    assertThat(method.getName()).isEqualTo("sil_getFilterChanges");
  }
  ...
  private JsonRpcRequestContext requestWithParams(final Object... params) {
    return new JsonRpcRequestContext(new JsonRpcRequest("2.0", "sil_getFilterChanges", params));
  }
