...
public class SilGetTransactionCountTest {
  private final Blockchain blockchain = mock(Blockchain.class);
  private final BlockchainQueries blockchainQueries = mock(BlockchainQueries.class);
  private final ChainHead chainHead = mock(ChainHead.class);

  private SilGetTransactionCount silGetTransactionCount;
  ...
  public void setup() {
    ...
    silGetTransactionCount = new SilGetTransactionCount(blockchainQueries, transactionPool);
  }
  ...
  public void shouldUsePendingTransactionsWhenToldTo() {
    ...
    final JsonRpcRequestContext request =
        new JsonRpcRequestContext(
            new JsonRpcRequest("1", "sil_getTransactionCount", pendingParams));
    final JsonRpcSuccessResponse response =
        (JsonRpcSuccessResponse) silGetTransactionCount.response(request);
