...
public class SilEstimateGasIntegrationTest {
  ...
  public void setUp() {
    ...
    method = methods.get("sil_estimateGas");
  }
  ...
  private JsonRpcRequestContext requestWithParams(final Object... params) {
    return new JsonRpcRequestContext(new JsonRpcRequest("2.0", "sil_estimateGas", params));
  }
}
