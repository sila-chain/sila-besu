...
public class SilGetFilterChangesIntegrationTest {

  @Mock private TransactionBroadcaster batchAddedListener;
  private MutableBlockchain blockchain;
  private final String SIL_METHOD = "sil_getFilterChanges";
  ...
  private SilGetFilterChanges method;
  ...
  public void setUp() {
    ...
    SilContext silContext = mock(SilContext.class, RETURNS_DEEP_STUBS);
    SilPeers silPeers = mock(SilPeers.class);
    ...
    method = new SilGetFilterChanges(filterManager);
  }
