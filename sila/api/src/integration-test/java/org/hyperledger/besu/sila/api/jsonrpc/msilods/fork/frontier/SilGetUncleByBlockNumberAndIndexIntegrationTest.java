...
public class SilGetUncleByBlockNumberAndIndexIntegrationTest {
  ...
  @BeforeEach
  public void setUp() {
    method = BLOCKCHAIN.methods().get("sil_getUncleByBlockNumberAndIndex");
  }
  ...
  private JsonRpcRequestContext getUncleByBlockNumberAndIndex() {
    return new JsonRpcRequestContext(
        new JsonRpcRequest(
            "2.0", "sil_getUncleByBlockNumberAndIndex", new Object[] {"0x4", "0x0"}));
  }
}
