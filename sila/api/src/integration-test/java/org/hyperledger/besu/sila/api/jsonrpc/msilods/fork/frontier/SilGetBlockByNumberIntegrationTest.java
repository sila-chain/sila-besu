 ...
 */
package org.hyperledger.besu.sila.api.jsonrpc.methods.fork.frontier;
...
import org.hyperledger.besu.sila.api.jsonrpc.JsonRpcResponseKey;
import org.hyperledger.besu.sila.api.jsonrpc.JsonRpcResponseUtils;
...
public class SilGetBlockByNumberIntegrationTest {

  private static final String SIL_METHOD = "sil_getBlockByNumber";
  ...
  @Test
  public void silMethodName() {
    final String silName = silGetBlockNumber().getName();

    assertThat(silName).matches(SIL_METHOD);
  }
  ...
  public void earliestBlockHashes() {
    ...
    final JsonRpcResponse actual = silGetBlockNumber().response(request);
  ...
  public void missingTagParameterBlockHashes() {
    ...
    final Throwable thrown = catchThrowable(() -> silGetBlockNumber().response(request));
  ...
  private JsonRpcMethod silGetBlockNumber() {
    final JsonRpcMethod method = methods.get(SIL_METHOD);
