...
public class SilGetBlockTransactionCountByNumber extends AbstractBlockParameterMethod {

  public SilGetBlockTransactionCountByNumber(final BlockchainQueries blockchain) {
    super(blockchain);
  }

  @Override
  public String getName() {
    return RpcMethod.SIL_GET_BLOCK_TRANSACTION_COUNT_BY_NUMBER.getMethodName();
  }
