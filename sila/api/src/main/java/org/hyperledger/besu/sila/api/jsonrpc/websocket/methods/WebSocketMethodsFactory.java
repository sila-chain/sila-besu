...
public class WebSocketMethodsFactory {
  ...
  private void buildWebsocketMethods(
    ...
    addMethods(
        new SilSubscribe(subscriptionManager, new SubscriptionRequestMapper(), maxFilterAddresses),
        new SilUnsubscribe(subscriptionManager, new SubscriptionRequestMapper()));
  }
