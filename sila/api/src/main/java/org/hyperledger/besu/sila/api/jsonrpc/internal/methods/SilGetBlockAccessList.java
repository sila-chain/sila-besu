...
public class SilGetBlockAccessList extends AbstractBlockParameterOrBlockHashMethod {

  public SilGetBlockAccessList(final BlockchainQueries blockchainQueries) {
    super(blockchainQueries);
  }

  @Override
  public String getName() {
    return RpcMethod.SIL_GET_BLOCK_ACCESS_LIST.getMethodName();
  }
