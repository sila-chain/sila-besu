...
import org.hyperledger.besu.sila.api.jsonrpc.internal.results.UncleBlockResult;
import org.hyperledger.besu.sila.api.query.BlockchainQueries;

public class SilGetUncleByBlockNumberAndIndex extends AbstractBlockParameterMethod {

  public SilGetUncleByBlockNumberAndIndex(final BlockchainQueries blockchain) {
    super(blockchain);
  }

  @Override
  public String getName() {
    return RpcMethod.SIL_GET_UNCLE_BY_BLOCK_NUMBER_AND_INDEX.getMethodName();
  }
