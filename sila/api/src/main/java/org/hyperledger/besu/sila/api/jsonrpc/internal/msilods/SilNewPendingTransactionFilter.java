...
public class SilNewPendingTransactionFilter implements JsonRpcMethod {

  private final FilterManager filterManager;

  public SilNewPendingTransactionFilter(final FilterManager filterManager) {
    this.filterManager = filterManager;
  }

  @Override
  public String getName() {
    return RpcMethod.SIL_NEW_PENDING_TRANSACTION_FILTER.getMethodName();
  }
