...
import org.hyperledger.besu.sila.api.jsonrpc.internal.parameters.TopicsDeserializer;
...
public class LogsQuery {
  ...
  public LogsQuery(
    ...
    // collection. However, the semantics of the Sila JSON-RPC APIs ascribe meaning to a null
