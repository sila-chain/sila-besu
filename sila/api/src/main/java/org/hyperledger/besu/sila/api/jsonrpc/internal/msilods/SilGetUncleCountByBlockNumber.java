...
public class SilGetUncleCountByBlockNumber extends AbstractBlockParameterMethod {

  public SilGetUncleCountByBlockNumber(final BlockchainQueries blockchain) {
    super(blockchain);
  }

  @Override
  public String getName() {
    return RpcMethod.SIL_GET_UNCLE_COUNT_BY_BLOCK_NUMBER.getMethodName();
  }
