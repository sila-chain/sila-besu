...
/**
 * Converts Sila transaction traces into a hierarchical call tracer format.
 *
 * <p>This class transforms the flat sequence of trace frames produced during transaction execution
 * into a structured call tree similar to Gsil's callTracer output. It captures the relationships
 * between calls, their inputs, outputs, gas usage, and error states.
 *
 * <p>The converter handles various SAVM operations including:
 *
 * <ul>
...
public class CallTracerResultConverter {
  ...
  private static void finalizePrecompileChild(
    ...
    // Calculate gas for precompile (Gsil-style)
