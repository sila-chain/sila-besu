...
public class SilGetCode extends AbstractBlockParameterOrBlockHashMethod {

  public SilGetCode(final BlockchainQueries blockchainQueries) {
    super(blockchainQueries);
  }

  public SilGetCode(final Supplier<BlockchainQueries> blockchainQueries) {
    super(blockchainQueries);
  }

  @Override
  public String getName() {
    return RpcMethod.SIL_GET_CODE.getMethodName();
  }
