 ...
 * spec (SilaAmsterdam+). Differs from {@link AbstractEngineForkchoiceUpdated} in two ways:
 *
 * <ol>
...
public abstract class AbstractEngineForkchoiceUpdatedV4 extends ExecutionEngineJsonRpcMethod {
  ...
  /** SilaCancun activation timestamp, if scheduled. */
  protected final Optional<Long> cancunMilestone;

  /** SilaAmsterdam activation timestamp, if scheduled. */
  ...
  public JsonRpcResponse syncResponse(final JsonRpcRequestContext requestContext) {
    ...
    // https://github.com/sila-chain/execution-apis/pull/786
