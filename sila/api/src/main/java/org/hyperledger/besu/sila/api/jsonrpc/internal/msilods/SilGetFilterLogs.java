...
public class SilGetFilterLogs implements JsonRpcMethod {

  private final FilterManager filterManager;

  public SilGetFilterLogs(final FilterManager filterManager) {
    this.filterManager = filterManager;
  }

  @Override
  public String getName() {
    return RpcMethod.SIL_GET_FILTER_LOGS.getMethodName();
  }
