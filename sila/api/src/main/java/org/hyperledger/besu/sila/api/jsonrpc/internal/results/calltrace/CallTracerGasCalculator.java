 ...
 *
 * <p>This class encapsulates all gas-related calculations needed to produce Gsil-compatible call
 ...
 *
 * <ul>
 *   <li>Gas provided to child calls (63/64 rule per SIP-150)
...
public final class CallTracerGasCalculator {
  ...
  /** Warm storage access cost per SIP-2929 */
  ...
  /**
   * SIP-150 gas stipend divisor. Child calls receive at most 63/64 of available gas. This is
   ...
   *
   * <p>This implements the SIP-150 rule where child calls receive at most 63/64 of available gas.
  ...
  /**
   * Calculates gas for precompile calls using Gsil-style calculation.
   *
   * <p>The calculation follows Gsil's approach:
   *
   * <ol>
