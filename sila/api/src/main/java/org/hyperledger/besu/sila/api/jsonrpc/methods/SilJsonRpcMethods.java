...
import org.hyperledger.besu.sila.api.jsonrpc.internal.methods.SilGetRawTransactionByHash;
  ...
  protected Map<String, JsonRpcMethod> create() {
    final Map<String, JsonRpcMethod> map =
        mapOf(
            ...
            new SilGetRawTransactionByHash(blockchainQueries, transactionPool),
