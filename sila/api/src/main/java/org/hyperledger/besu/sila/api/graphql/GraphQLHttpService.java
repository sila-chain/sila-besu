...
import org.hyperledger.besu.sila.api.graphql.internal.response.GraphQLErrorResponse;
import org.hyperledger.besu.sila.api.graphql.internal.response.GraphQLJsonRequest;
import org.hyperledger.besu.sila.api.graphql.internal.response.GraphQLResponse;
import org.hyperledger.besu.sila.api.graphql.internal.response.GraphQLResponseType;
import org.hyperledger.besu.sila.api.graphql.internal.response.GraphQLSuccessResponse;
import org.hyperledger.besu.sila.api.handlers.IsAliveHandler;
...
public class GraphQLHttpService {
   ...
   * @param scheduler {@link SilScheduler} used to trigger timeout on backend queries
   */
              ...
              if (cause instanceof SocketException) {
                resultFuture.completeExceptionally(
                    new GraphQLServiceException(
                        String.format(
                            "Failed to bind Sila GraphQL HTTP listener to %s:%s: %s",
