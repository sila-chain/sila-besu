...
public class SilMaxPriorityFeePerGas implements JsonRpcMethod {

  private final BlockchainQueries blockchainQueries;

  public SilMaxPriorityFeePerGas(final BlockchainQueries blockchainQueries) {
    this.blockchainQueries = blockchainQueries;
  }

  @Override
  public String getName() {
    return RpcMethod.SIL_GET_MAX_PRIORITY_FEE_PER_GAS.getMethodName();
  }
