 ...
 */
package org.hyperledger.besu.sila.api.jsonrpc.websocket.subscription.response;
...
public class SubscriptionResponse {
  ...
  private static final String SIL_SUBSCRIPTION_METHOD = "sil_subscription";
  ...
  public SubscriptionResponse(final Subscription subscription, final JsonRpcResult result) {
    ...
    this.methodName = SIL_SUBSCRIPTION_METHOD;
    this.params =
