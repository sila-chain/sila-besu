...
public class SilEstimateGas extends AbstractEstimateGas {
  private static final Logger LOG = LoggerFactory.getLogger(SilEstimateGas.class);
  ...
  public String getName() {
    return RpcMethod.SIL_ESTIMATE_GAS.getMethodName();
  }
