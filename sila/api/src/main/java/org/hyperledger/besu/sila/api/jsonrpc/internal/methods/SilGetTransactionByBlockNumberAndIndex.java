...
public class SilGetTransactionByBlockNumberAndIndex extends AbstractBlockParameterMethod {

  public SilGetTransactionByBlockNumberAndIndex(final BlockchainQueries blockchain) {
    super(blockchain);
  }

  @Override
  public String getName() {
    return RpcMethod.SIL_GET_TRANSACTION_BY_BLOCK_NUMBER_AND_INDEX.getMethodName();
  }
