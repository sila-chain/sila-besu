...
public enum RpcErrorType implements RpcMethodError {
  ...
  SIL_SEND_TX_NOT_AVAILABLE(
      -32604,
      "The method sil_sendTransaction is not supported. Use sil_sendRawTransaction to send a signed transaction to Besu."),
  SIL_SEND_TX_ALREADY_KNOWN(-32000, "Known transaction"),
  SIL_SEND_TX_REPLACEMENT_UNDERPRICED(-32000, "Replacement transaction underpriced"),
  // P2P related errors
