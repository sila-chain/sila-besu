...
public class SilUninstallFilter implements JsonRpcMethod {

  private final FilterManager filterManager;

  public SilUninstallFilter(final FilterManager filterManager) {
    this.filterManager = filterManager;
  }

  @Override
  public String getName() {
    return RpcMethod.SIL_UNINSTALL_FILTER.getMethodName();
  }
