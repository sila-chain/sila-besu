...
public class SilGetBlockByNumber extends AbstractBlockParameterMethod {

  private final BlockResultFactory blockResult;
  private final boolean includeCoinbase;
  private static final Logger LOGGER = LoggerFactory.getLogger(SilGetBlockByNumber.class);
  private final Synchronizer synchronizer;

  public SilGetBlockByNumber(
  ...
  public String getName() {
    return RpcMethod.SIL_GET_BLOCK_BY_NUMBER.getMethodName();
  }
