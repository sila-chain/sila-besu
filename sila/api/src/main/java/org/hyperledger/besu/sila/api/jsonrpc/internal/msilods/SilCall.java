...
public class SilCall extends AbstractBlockParameterOrBlockHashMethod {
  ...
  public SilCall(
    ...
    this.gasUsedCounter =
        metricsSystem.createLabelledCounter(
            ...
            "sil_call_gas_used_total",
            "Total gas used by sil_call requests",
            "status");
  }

  @Override
  public String getName() {
    return RpcMethod.SIL_CALL.getMethodName();
  }
