...
public class SilSendRawTransaction implements JsonRpcMethod {
  private static final Logger LOG = LoggerFactory.getLogger(SilSendRawTransaction.class);

  private final boolean sendEmptyHashOnInvalidBlock;

  private final Supplier<TransactionPool> transactionPool;

  public SilSendRawTransaction(final TransactionPool transactionPool) {
    this(Suppliers.ofInstance(transactionPool), false);
  }

  public SilSendRawTransaction(
  ...
  public String getName() {
    return RpcMethod.SIL_SEND_RAW_TRANSACTION.getMethodName();
  }
