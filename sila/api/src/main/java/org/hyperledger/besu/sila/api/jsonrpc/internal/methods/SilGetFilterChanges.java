...
public class SilGetFilterChanges implements JsonRpcMethod {

  private final FilterManager filterManager;

  public SilGetFilterChanges(final FilterManager filterManager) {
    this.filterManager = filterManager;
  }

  @Override
  public String getName() {
    return RpcMethod.SIL_GET_FILTER_CHANGES.getMethodName();
  }
