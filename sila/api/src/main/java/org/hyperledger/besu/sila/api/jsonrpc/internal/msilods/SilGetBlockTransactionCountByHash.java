...
public class SilGetBlockTransactionCountByHash implements JsonRpcMethod {

  private final BlockchainQueries blockchain;

  public SilGetBlockTransactionCountByHash(final BlockchainQueries blockchain) {
    this.blockchain = blockchain;
  }

  @Override
  public String getName() {
    return RpcMethod.SIL_GET_BLOCK_TRANSACTION_COUNT_BY_HASH.getMethodName();
  }
