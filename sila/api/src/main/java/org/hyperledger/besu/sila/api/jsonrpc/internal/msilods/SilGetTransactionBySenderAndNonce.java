...
public class SilGetTransactionBySenderAndNonce implements JsonRpcMethod {

  private final BlockchainQueries blockchainQueries;
  private final TransactionPool transactionPool;

  public SilGetTransactionBySenderAndNonce(
  ...
  public String getName() {
    return RpcMethod.SIL_GET_TRANSACTION_BY_SENDER_AND_NONCE.getMethodName();
  }
