...
public class SilGetUncleCountByBlockHash implements JsonRpcMethod {

  private final BlockchainQueries blockchain;

  public SilGetUncleCountByBlockHash(final BlockchainQueries blockchain) {
    this.blockchain = blockchain;
  }

  @Override
  public String getName() {
    return RpcMethod.SIL_GET_UNCLE_COUNT_BY_BLOCK_HASH.getMethodName();
  }
