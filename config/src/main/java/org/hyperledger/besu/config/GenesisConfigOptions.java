...
public interface GenesisConfigOptions {
  ...
  /**
   * Set a Zero Base Fee network so that free gas can be used with London/SIP-1559. Once the chain
  ...
  /**
   * Force a Base Fee as Gas Price network to used with London/SIP-1559.
   *
