...
public class StubGenesisConfigOptions implements GenesisConfigOptions, Cloneable {
   ...
   * @return the stub genesis config options
   */
  public StubGenesisConfigOptions sip150Block(final long blockNumber) {
   ...
   * @return the stub genesis config options
   */
  public StubGenesisConfigOptions sip158Block(final long blockNumber) {
  ...
  /**
   * SilaShanghai time stub genesis config options.
   *
