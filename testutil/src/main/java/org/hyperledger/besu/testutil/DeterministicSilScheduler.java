...
public class DeterministicSilScheduler extends SilScheduler {
  ...
  public DeterministicSilScheduler() {
   ...
   */
  public DeterministicSilScheduler(final TimeoutPolicy timeoutPolicy) {
    super(
