 ...
 * to the scope of Sila. While it is assumed that the ultimate external actor will be human in
...
public interface Transaction {
  ...
  /**
   * A scalar value equal to the number of Wei to be paid in total, as specified in SIP-1559.
   *
  ...
  /**
   * An unlimited size byte array specifying the SAVM-code for the account // initialisation
   * procedure.
   *
  ...
  /**
   * Return the access list in case of SIP-2930 transaction
   *
