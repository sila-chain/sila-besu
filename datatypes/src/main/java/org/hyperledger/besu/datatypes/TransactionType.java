...
public enum TransactionType {
  ...
  private static final Set<TransactionType> ACCESS_LIST_SUPPORTED_TRANSACTION_TYPES =
      EnumSet.of(ACCESS_LIST, SIP1559, BLOB, DELEGATE_CODE);
  ...
  /**
   * Gets serialized type for returning in an sil transaction result, factoring in the special case
  ...
  /**
   * Convert from SIL serialized byte to type value.
   *
  ...
  /**
   * Does transaction type support SIP-1559 fee market.
   *
   * @return the boolean
   */
