...
/**
 * Interface defining parameters for Sila transaction calls and simulations.
 *
 * <p>This interface provides access to all the parameters that can be specified when making calls
 * to the Sila network, including both legacy and SIP-1559 transaction parameters, as well as
 * SIP-4844 blob transaction parameters.
 *
...
public interface CallParameter {
  ...
  /**
   * Returns the maximum priority fee per gas (SIP-1559).
   *
  ...
  /**
   * Returns the maximum fee per gas (SIP-1559).
   *
  ...
  /**
   * Returns the maximum fee per blob gas (SIP-4844).
   *
   ...
   *
   * <p>This parameter is used in pre-SIP-1559 transactions to specify the price per unit of gas.
   *
  ...
  /**
   * Returns the access list for the transaction (SIP-2930).
   *
  ...
  /**
   * Returns the blob versioned hashes for blob transactions (SIP-4844).
   *
